				...
				if spellID == 2139 or spellID == 119308 then -- COUNTERSPELL / IMPROVED COUNTERSPELL
					...
					if RSA.db.profile.Mage.Spells.Counterspell.Messages.Start ~= "" then
						...
						if RSA.db.profile.Mage.Spells.Counterspell.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Mage.Spells.Counterspell.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Mage.Spells.Counterspell.Party == true then
							if RSA.db.profile.Mage.Spells.Counterspell.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Mage.Spells.Counterspell.Raid == true then
							if RSA.db.profile.Mage.Spells.Counterspell.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_MISSED" and missType ~= "IMMUNE" then
				if spellID == 2139 then -- COUNTERSPELL
					...
					if RSA.db.profile.Mage.Spells.Counterspell.Messages.End ~= "" then
						...
						if RSA.db.profile.Mage.Spells.Counterspell.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Mage.Spells.Counterspell.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Mage.Spells.Counterspell.Party == true then
							if RSA.db.profile.Mage.Spells.Counterspell.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 30449 then -- SPELLSTEAL
					...
					if RSA.db.profile.Mage.Spells.Spellsteal.Messages.End ~= "" then
						...
						if RSA.db.profile.Mage.Spells.Spellsteal.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Mage.Spells.Spellsteal.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Mage.Spells.Spellsteal.Party == true then
							if RSA.db.profile.Mage.Spells.Spellsteal.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Mage.Spells.Spellsteal.Raid == true then
							if RSA.db.profile.Mage.Spells.Spellsteal.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_MISSED" and missType == "IMMUNE" then
				if spellID == 2139 then -- COUNTERSPELL
					...
					if RSA.db.profile.Mage.Spells.Counterspell.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Mage.Spells.Counterspell.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Mage.Spells.Counterspell.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Mage.Spells.Counterspell.Party == true then
							if RSA.db.profile.Mage.Spells.Counterspell.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
