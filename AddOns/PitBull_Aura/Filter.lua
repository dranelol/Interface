...
local VERSION = tonumber(("$Revision: 1901 $"):match("%d+"))

local PitBull = PitBull
local PitBull_Aura = PitBull:GetModule("Aura")
local self = PitBull_Aura
PitBull:ProvideVersion("$Revision: 1901 $", "$Date: 2010-03-23 22:05:40 +0000 (Tue, 23 Mar 2010) $")
...
elseif playerClass == 'SHAMAN' then
	canDispel = {
		["Poison"] = true,
		["Disease"] = true,
		["Curse"] = scanForKnownTalent(51886),
	}
	selfBuffs = {
	...
	friendDebuffs = {
		[57723] = playerRace == "Draenei" or nil, -- Exhaustion
		[57724] = (playerRace == "Troll" or playerRace == "Tauren" or playerRace == "Orc") or nil, -- Sated
	}
	petBuffs = {
		[58875] = true, -- Spirit Walk
	}
elseif playerClass == 'PALADIN' then
	...
	selfBuffs = {
		...
		[53736] = playerRace == "BloodElf" or nil, -- Seal of Corruption
		[20164] = true, -- Seal of Justice
		[20165] = true, -- Seal of Light
		[53720] = (playerRace == "Human" or playerRace == "Dwarf" or playerRace == "Draenei") or nil, -- Seal of the Martyr
		[20154] = true, -- Seal of Righteousness
		[31801] = (playerRace == "Human" or playerRace == "Dwarf" or playerRace == "Draenei") or nil, -- Seal of Vengeance
	...
	enemyDebuffs = {
		...
		[53742] = playerRace == "BloodElf" or nil, -- Dot, from Seal of Corruption (Blood Corruption)
		[20116] = true, -- Consecration
		[853]   = true, -- Hammer of Justice
		[21183]	= true, -- Heart of the Crusader
		[31803] = (playerRace == "Human" or playerRace == "Dwarf" or playerRace == "Draenei") or nil, -- Dot from, Seal of Vengeance (Holy Vengeance)
...
elseif playerRace == "Troll" then
	selfBuffs[26297] = true -- Berserking
...
local function turn(t)
	...
	for k in pairs(t) do
		...
		if not spell then
			DEFAULT_CHAT_FRAME:AddMessage(("PitBull_Aura: Unknown spell ID: %d"):format(k))
		else
			tmp[spell] = true
		end
		t[k] = nil
