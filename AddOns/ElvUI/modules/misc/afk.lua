...
function AFK:SetAFK(status)
	...
	if(status) then
		...
		-- Added by Drane 10.27.2014
		--self.AFKMode.bottom.playerTarget:SetUnit("target")
		self.AFKMode.bottom.playerTarget:SetCreature(40624)
		-- </added>
...
function AFK:Initialize()
	...
	-- <Added by Drane 10.27.2014>
	self.AFKMode.bottom.playerTarget = CreateFrame("PlayerModel", "ElvUIAFKPlayerTargetModel", self.AFKMode.bottom)
	self.AFKMode.bottom.playerTarget:SetPoint("BOTTOMLEFT", self.AFKMode.bottom, "BOTTOMLEFT", 120, -100)
	self.AFKMode.bottom.playerTarget:SetSize(800, 1600)
	self.AFKMode.bottom.playerTarget:SetCamDistanceScale(3)
	self.AFKMode.bottom.playerTarget:SetFacing(6)
