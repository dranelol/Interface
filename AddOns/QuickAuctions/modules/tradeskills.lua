...
function Tradeskill:CreateFrame()
	...
	self.button:SetPoint("TOPRIGHT", TradeSkillFrame, "TOPRIGHT", -26, -2)
	...
	self.buy:SetPoint("TOPLEFT", TradeSkillFrame, "TOPLEFT", 56, -2)
	...
	self.frame:SetPoint("TOPLEFT", TradeSkillFrame, "TOPRIGHT", 4, 2)
	self.frame:Hide()
