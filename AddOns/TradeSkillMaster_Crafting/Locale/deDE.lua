...
L["Default Craft Price Method"] = "Standard Herstellungspreismethode" -- Needs review
L["Default Material Cost Method"] = "Standard Herstellungskostenmethode" -- Needs review
L["Default Price"] = "Standardpreis" -- Needs review
L["Default Price Settings"] = "Standard Preis Einstellungen" -- Needs review
...
L["Exclude Crafts with a Cooldown from Craft Cost"] = "Lasse Stücke mit Cooldown bei Herstellungskosten aus" -- Needs review
L["Filters >>"] = "Filter >>" -- Needs review
L["First select a crafter"] = "Wähle zuerst einen Hersteller" -- Needs review
L["Gather"] = "Sammeln" -- Needs review
-- L["Gather All Professions by Default if Only One Crafter"] = ""
L["Gathering"] = "Sammeln"
-- L["Gathering Crafting Mats"] = ""
L["Gather Items"] = "Sammle Gegenstände" -- Needs review
L["General"] = "Allgemein"
...
L["Would you like to automatically create some TradeSkillMaster groups for this profession?"] = "Möchtest du, dass TSM automatisch eine Gruppe für diesen Beruf erstellt?" -- Needs review
