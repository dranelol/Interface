...
function Gladius:UpdateFrame()
	...
	for i=1, currentBracket do
		...
		if (db.powerBar) then
			button.castBar:SetPoint("TOPLEFT",button,"BOTTOMLEFT",db.castBarHeight,-3-db.manaBarHeight)
		else
			button.castBar:SetPoint("TOPLEFT",button,"BOTTOMLEFT",db.castBarHeight,-3)
		end			
