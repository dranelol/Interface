			...
			if event == "SPELL_CAST_SUCCESS" then
				if spellID == 115546 then -- PROVOKE
					...
					if UnitName(dest) == "Statue of the Black Ox" and RSA.db.profile.Monk.Spells.Provoke.Messages.StatueOfTheBlackOx ~= "" then -- FIND OUT HOW TO OBTAIN NAME, ID OR WHATEVER
						...
						if RSA.db.profile.Monk.Spells.Provoke.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Monk.Spells.Provoke.Messages.StatueOfTheBlackOx, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Provoke.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.Provoke.Messages.StatueOfTheBlackOx, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Provoke.Party == true then
							if RSA.db.profile.Monk.Spells.Provoke.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Monk.Spells.Provoke.Raid == true then
							if RSA.db.profile.Monk.Spells.Provoke.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 119582 then -- PURIFYING BREW
					...
					if RSA.db.profile.Monk.Spells.PurifyingBrew.Messages.Start ~= "" then
						...
						if RSA.db.profile.Monk.Spells.PurifyingBrew.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Monk.Spells.PurifyingBrew.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.PurifyingBrew.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.PurifyingBrew.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.PurifyingBrew.Party == true then
							if RSA.db.profile.Monk.Spells.PurifyingBrew.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Monk.Spells.PurifyingBrew.Raid == true then
							if RSA.db.profile.Monk.Spells.PurifyingBrew.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_AURA_APPLIED" then
				if spellID == 115176 and dest == pName then -- ZEN MEDITATION
					...
					if RSA.db.profile.Monk.Spells.ZenMeditation.Messages.Start ~= "" then
						...
						if RSA.db.profile.Monk.Spells.ZenMeditation.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Monk.Spells.ZenMeditation.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.ZenMeditation.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.ZenMeditation.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.ZenMeditation.Party == true then
							if RSA.db.profile.Monk.Spells.ZenMeditation.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Monk.Spells.ZenMeditation.Raid == true then
							if RSA.db.profile.Monk.Spells.ZenMeditation.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 116189 then -- PROVOKE
					...
					if RSA.db.profile.Monk.Spells.Provoke.Messages.Start ~= "" then
						...
						if RSA.db.profile.Monk.Spells.Provoke.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.Provoke.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Provoke.Party == true then
							if RSA.db.profile.Monk.Spells.Provoke.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 120954 then -- FORTIFYING BREW
					...
					if RSA.db.profile.Monk.Spells.FortifyingBrew.Messages.Start ~= "" then
						...
						if RSA.db.profile.Monk.Spells.FortifyingBrew.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Monk.Spells.FortifyingBrew.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.FortifyingBrew.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.FortifyingBrew.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.FortifyingBrew.Party == true then
							if RSA.db.profile.Monk.Spells.FortifyingBrew.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Monk.Spells.FortifyingBrew.Raid == true then
							if RSA.db.profile.Monk.Spells.FortifyingBrew.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 115078 then -- PARALYSIS
					...
					if RSA.db.profile.Monk.Spells.Paralysis.Messages.Start ~= "" then
						...
						if RSA.db.profile.Monk.Spells.Paralysis.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Monk.Spells.Paralysis.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Paralysis.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.Paralysis.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Paralysis.Party == true then
							if RSA.db.profile.Monk.Spells.Paralysis.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Monk.Spells.Paralysis.Raid == true then
							if RSA.db.profile.Monk.Spells.Paralysis.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Monk.Spells.Paralysis.Messages.Start, ".%a+.", RSA.String_Replace))
						end
					end
				end -- PARALYSIS
				if spellID == 115213 and dest == pName then -- AVERT HARM
					spellinfo = GetSpellInfo(spellID)
					spelllinkinfo = GetSpellLink(spellID)
					RSA.Replacements = {["[SPELL]"] = spellinfo, ["[LINK]"] = spelllinkinfo, ["[TARGET]"] = dest,}
					if RSA.db.profile.Monk.Spells.AvertHarm.Messages.Start ~= "" then
						if RSA.db.profile.Monk.Spells.AvertHarm.Local == true then
							RSA.Print_LibSink(string.gsub(RSA.db.profile.Monk.Spells.AvertHarm.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.AvertHarm.Yrll == true then
							RSA.Print_Yell(string.gsub(RSA.db.profile.Monk.Spells.AvertHarm.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.AvertHarm.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Monk.Spells.AvertHarm.Messages.Start, ".%a+.", RSA.String_Replace), RSA.db.profile.Monk.Spells.AvertHarm.CustomChannel.Channel)
						end
						if RSA.db.profile.Monk.Spells.AvertHarm.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Monk.Spells.AvertHarm.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.AvertHarm.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.AvertHarm.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.AvertHarm.Party == true then
							if RSA.db.profile.Monk.Spells.AvertHarm.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							RSA.Print_Party(string.gsub(RSA.db.profile.Monk.Spells.AvertHarm.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.AvertHarm.Raid == true then
							if RSA.db.profile.Monk.Spells.AvertHarm.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Monk.Spells.AvertHarm.Messages.Start, ".%a+.", RSA.String_Replace))
						end
					end
				end -- AVERT HARM
				if spellID == 115295 then -- GUARD
					...
					if RSA.db.profile.Monk.Spells.Guard.Messages.Start ~= "" then
						...
						if RSA.db.profile.Monk.Spells.Guard.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Monk.Spells.Guard.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Guard.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.Guard.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Guard.Party == true then
							if RSA.db.profile.Monk.Spells.Guard.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Monk.Spells.Guard.Raid == true then
							if RSA.db.profile.Monk.Spells.Guard.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 115308 then -- ELUSIVE BREW
					...
					if RSA.db.profile.Monk.Spells.ElusiveBrew.Messages.Start ~= "" then
						...
						if RSA.db.profile.Monk.Spells.ElusiveBrew.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Monk.Spells.ElusiveBrew.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.ElusiveBrew.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.ElusiveBrew.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.ElusiveBrew.Party == true then
							if RSA.db.profile.Monk.Spells.ElusiveBrew.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Monk.Spells.ElusiveBrew.Raid == true then
							if RSA.db.profile.Monk.Spells.ElusiveBrew.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 122278 then -- DAMPEN HARM
					...
					if RSA.db.profile.Monk.Spells.DampenHarm.Messages.Start ~= "" then
						...
						if RSA.db.profile.Monk.Spells.DampenHarm.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Monk.Spells.DampenHarm.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.DampenHarm.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.DampenHarm.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.DampenHarm.Party == true then
							if RSA.db.profile.Monk.Spells.DampenHarm.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Monk.Spells.DampenHarm.Raid == true then
							if RSA.db.profile.Monk.Spells.DampenHarm.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 116849 then -- LIFE COCOON
					...
					if RSA.db.profile.Monk.Spells.LifeCocoon.Messages.Start ~= "" then
						...
						if RSA.db.profile.Monk.Spells.LifeCocoon.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Monk.Spells.LifeCocoon.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.LifeCocoon.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.LifeCocoon.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.LifeCocoon.Party == true then
							if RSA.db.profile.Monk.Spells.LifeCocoon.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Monk.Spells.LifeCocoon.Raid == true then
							if RSA.db.profile.Monk.Spells.LifeCocoon.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 122783 then -- DIFFUSE MAGIC
					...
					if RSA.db.profile.Monk.Spells.DiffuseMagic.Messages.Start ~= "" then
						...
						if RSA.db.profile.Monk.Spells.DiffuseMagic.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Monk.Spells.DiffuseMagic.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.DiffuseMagic.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.DiffuseMagic.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.DiffuseMagic.Party == true then
							if RSA.db.profile.Monk.Spells.DiffuseMagic.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Monk.Spells.DiffuseMagic.Raid == true then
							if RSA.db.profile.Monk.Spells.DiffuseMagic.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_AURA_REMOVED" then
				if spellID == 115176 and dest == pName then -- ZEN MEDITATION
					...
					if RSA.db.profile.Monk.Spells.ZenMeditation.Messages.End ~= "" then
						...
						if RSA.db.profile.Monk.Spells.ZenMeditation.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.ZenMeditation.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.ZenMeditation.Party == true then
							if RSA.db.profile.Monk.Spells.ZenMeditation.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 120954 then -- FORTIFYING BREW
					...
					if RSA.db.profile.Monk.Spells.FortifyingBrew.Messages.End ~= "" then
						...
						if RSA.db.profile.Monk.Spells.FortifyingBrew.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.FortifyingBrew.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.FortifyingBrew.Party == true then
							if RSA.db.profile.Monk.Spells.FortifyingBrew.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 115078 then -- PARALYSIS
					...
					if RSA.db.profile.Monk.Spells.Paralysis.Messages.End ~= "" then
						...
						if RSA.db.profile.Monk.Spells.Paralysis.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.Paralysis.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Paralysis.Party == true then
							if RSA.db.profile.Monk.Spells.Paralysis.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 115213 and dest == pName then -- AVERT HARM
					...
					spelllinkinfo = GetSpellLink(spellID)
					RSA.Replacements = {["[SPELL]"] = spellinfo, ["[LINK]"] = spelllinkinfo, ["[TARGET]"] = dest,}
					if RSA.db.profile.Monk.Spells.AvertHarm.Messages.End ~= "" then
						if RSA.db.profile.Monk.Spells.AvertHarm.Local == true then
							RSA.Print_LibSink(string.gsub(RSA.db.profile.Monk.Spells.AvertHarm.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.AvertHarm.Yell == true then
							RSA.Print_Yell(string.gsub(RSA.db.profile.Monk.Spells.AvertHarm.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.AvertHarm.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Monk.Spells.AvertHarm.Messages.End, ".%a+.", RSA.String_Replace), RSA.db.profile.Monk.Spells.AvertHarm.CustomChannel.Channel)
						end
						if RSA.db.profile.Monk.Spells.AvertHarm.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Monk.Spells.AvertHarm.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.AvertHarm.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.AvertHarm.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.AvertHarm.Party == true then
							if RSA.db.profile.Monk.Spells.AvertHarm.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							RSA.Print_Party(string.gsub(RSA.db.profile.Monk.Spells.AvertHarm.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.AvertHarm.Raid == true then
							if RSA.db.profile.Monk.Spells.AvertHarm.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Monk.Spells.AvertHarm.Messages.End, ".%a+.", RSA.String_Replace))
						end
					end
				end -- AVERT HARM
				if spellID == 115295 then -- GUARD
					...
					if RSA.db.profile.Monk.Spells.Guard.Messages.End ~= "" then
						...
						if RSA.db.profile.Monk.Spells.Guard.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.Guard.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Guard.Party == true then
							if RSA.db.profile.Monk.Spells.Guard.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 115308 then -- ELUSIVE BREW
					...
					if RSA.db.profile.Monk.Spells.ElusiveBrew.Messages.End ~= "" then
						...
						if RSA.db.profile.Monk.Spells.ElusiveBrew.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.ElusiveBrew.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.ElusiveBrew.Party == true then
							if RSA.db.profile.Monk.Spells.ElusiveBrew.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 122278 then -- DAMPEN HARM
					...
					if RSA.db.profile.Monk.Spells.DampenHarm.Messages.End ~= "" then
						...
						if RSA.db.profile.Monk.Spells.DampenHarm.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.DampenHarm.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.DampenHarm.Party == true then
							if RSA.db.profile.Monk.Spells.DampenHarm.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 116849 then -- LIFE COCOON
					...
					if RSA.db.profile.Monk.Spells.LifeCocoon.Messages.End ~= "" then
						...
						if RSA.db.profile.Monk.Spells.LifeCocoon.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.LifeCocoon.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.LifeCocoon.Party == true then
							if RSA.db.profile.Monk.Spells.LifeCocoon.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 122783 then -- DIFFUSE MAGIC
					...
					if RSA.db.profile.Monk.Spells.DiffuseMagic.Messages.End ~= "" then
						...
						if RSA.db.profile.Monk.Spells.DiffuseMagic.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.DiffuseMagic.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.DiffuseMagic.Party == true then
							if RSA.db.profile.Monk.Spells.DiffuseMagic.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_INTERRUPT" then
				if spellID == 116705 then -- SPEAR HAND STRIKE
					...
					if RSA.db.profile.Monk.Spells.SpearHandStrike.Messages.Start ~= "" then
						...
						if RSA.db.profile.Monk.Spells.SpearHandStrike.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Monk.Spells.SpearHandStrike.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.SpearHandStrike.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.SpearHandStrike.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.SpearHandStrike.Party == true then
							if RSA.db.profile.Monk.Spells.SpearHandStrike.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Monk.Spells.SpearHandStrike.Raid == true then
							if RSA.db.profile.Monk.Spells.SpearHandStrike.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_MISSED" and missType ~= "Immune" then
				if spellID == 116189 then -- PROVOKE
					...
					if RSA.db.profile.Monk.Spells.Provoke.Messages.End ~= "" then
						...
						if RSA.db.profile.Monk.Spells.Provoke.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.Provoke.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Provoke.Party == true then
							if RSA.db.profile.Monk.Spells.Provoke.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 116705 then -- SPEAR HAND STRIKE
					...
					if RSA.db.profile.Monk.Spells.SpearHandStrike.Messages.End ~= "" then
						...
						if RSA.db.profile.Monk.Spells.SpearHandStrike.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.SpearHandStrike.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.SpearHandStrike.Party == true then
							if RSA.db.profile.Monk.Spells.SpearHandStrike.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_MISSED" and missType == "Immune" then
				if spellID == 116189 then -- PROVOKE
					...
					if RSA.db.profile.Monk.Spells.Provoke.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Monk.Spells.Provoke.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.Provoke.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Provoke.Party == true then
							if RSA.db.profile.Monk.Spells.Provoke.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 116705 then -- SPEAR HAND STRIKE
					...
					if RSA.db.profile.Monk.Spells.SpearHandStrike.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Monk.Spells.SpearHandStrike.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.SpearHandStrike.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.SpearHandStrike.Party == true then
							if RSA.db.profile.Monk.Spells.SpearHandStrike.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 115078 then -- PARALYSIS
					...
					if RSA.db.profile.Monk.Spells.Paralysis.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Monk.Spells.Paralysis.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.Paralysis.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Paralysis.Party == true then
							if RSA.db.profile.Monk.Spells.Paralysis.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if spell == GetSpellInfo(115178) and RSA.db.profile.Monk.Spells.Resuscitate.Messages.Start ~= "" then -- RESUSCITATE
				if event == "UNIT_SPELLCAST_SENT" then
					...
					if RSA.db.profile.Monk.Spells.Resuscitate.Messages.Start ~= "" then
						...
						if RSA.db.profile.Monk.Spells.Resuscitate.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Monk.Spells.Resuscitate.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Resuscitate.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.Resuscitate.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Resuscitate.Party == true then
							if RSA.db.profile.Monk.Spells.Resuscitate.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Monk.Spells.Resuscitate.Raid == true then
							if RSA.db.profile.Monk.Spells.Resuscitate.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				elseif event == "UNIT_SPELLCAST_SUCCEEDED" and Ressed ~= true then
					...
					if RSA.db.profile.Monk.Spells.Resuscitate.Messages.End ~= "" then
						...
						if RSA.db.profile.Monk.Spells.Resuscitate.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Monk.Spells.Resuscitate.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Monk.Spells.Resuscitate.Party == true then
							if RSA.db.profile.Monk.Spells.Resuscitate.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
