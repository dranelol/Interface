...
L["Add"] = "Hinzufügen"
L["Add New Artwork"] = "Neues Artwork hinzufügen"
...
L["Artwork"] = "Artwork"
L["Artwork already exists. Overwrite?"] = "Artwork existiert bereits. Überschreiben?"
L["Artwork Name"] = "Artwork Name"
L["Artwork Path"] = "Artwork Pfad"
L["Artwork to use for a background."] = "Artwork für den Hintergrund"
L["Artwork Type"] = "Artwork Typ"
L["Background"] = "Hintergrund"
L["Background Color"] = "Hintergrundfarbe"
L["Background Color Blending"] = "Mischung Hintergrund Farbe "
L["Background color of this panel."] = "Hintergrundfarbe dieses Panels."
L["Background Color Style"] = "Hintergrund Farbstil"
L["Background Gradient Color"] = "Farbe für Hintergrund Farbverlauf"
L["Background Gradient Style"] = "Hintergrund Farbverlauf Stil"
L["Background Insets"] = "Hintergrund Einsätze"
L["Backgrounds"] = "Hintergründe"
L["Background Texture"] = "Hintergrundtextur"
L["Blend"] = "Mischen"
L["Blend mode for the background color."] = "Misch Modus für die Hintergrundfarbe"
L["Blizzard"] = "Blizzard"
L["Blizzard Dialog"] = "Blizzard Dialog"
L["Blizzard Tooltip"] = "Blizzard Tooltip"
L["Border artwork."] = "Rahmen Artwork"
...
L["Colors"] = "Farben"
L["Color style of this panel. NOTE: None disables background coloring."] = "Farb Stil dieses Panels. Hinweis: None (keiner) schaltet das Hintergrund einfärben ab."
...
L["Create"] = "Erstellen"
L["Create a new entry in the Artwork Library"] = "Erstelle einen neuen Eintrag in der Artwork-Bibiliothek"
...
L["Default Panel Options"] = "Voreingestellte Panel Optionen"
L["Delete"] = "Löschen"
...
L["FAQ_6_3"] = [=[|cffffffffWie importiere ich meine alten eePanels Setups?|
...
L["Import complete, eePanels is now OFF, remember to disable or rmove eePanels2"] = "Import abgeschlossen, eePanels ist jetzt AUS, nicht vergessen eePanels2 zu deaktivieren oder zu löschen."
...
L["Indicate what type of artwork you are adding."] = "Gibt an, welchen Typ von Bildmaterial du hinzufügen möchtest." -- Needs review
...
L["kgPanel"] = "kgPanel"
L["kgPanels Layout Export"] = "kgPanels Layout Export"
L["Layout Name"] = "Layout Name"
L["Layouts"] = "Layouts"
L["Layout tab"] = "Layout Tab"
L["Left"] = "Links"
L["Left background inset."] = "Einfügen Linker Hintergrund"
L["Level"] = "Level"
L["LLx"] = "LLx"
L["LLy"] = "LLy"
L["Lock Panel"] = "Panel sperren"
L["Lock/Unlock this panel."] = "Diesen Panel sperren/entsperren."
L["Low"] = "niedrig"
L["LRx"] = "LRx"
L["LRy"] = "LRy"
L["Medium"] = "Medium"
...
L["Panel Creation"] = "Panel Erstellung"
L["Panel height."] = "Panel Höhe."
L["Panel Height"] = "Panel-Höhe"
L["Panel Layout"] = "Panel Layout"
L["Panel level, for Z-Indexing."] = "Panel Level, für Z-Indexing."
L["Panel Name"] = "Panel-Name"
L["Panel Opacity"] = "Panel Sichtbarkeit"
L["Panel scaling options."] = "Panel skallierungs Optionen."
L["Panel width."] = "Panel Breite."
L["Panel Width"] = "Panel-Breite"
L["Panel you wish to copy from."] = "Panel von dem du kopieren willst"
L["Parent And Anchor Settings"] = "Ursprungs und Anker Einstellungen"
L["Parent Frame"] = "Ursprungs Rahmen"
L["Paste"] = "Einfügen"
...
L["Press Cmd-A to select the text, then Cmd-C to copy."] = "Drücke Strg + A um den Text zu markieren und dann Strg + C zum kopieren."
L["Press Ctrl-A to select the text, then Ctrl-C to copy."] = "Drücke Strg-A um den Text auszuwählen, dann Strg-C zum Kopieren."
L["Remove Panel"] = "Panel entfernen"
L["Rename"] = "Umbenennen"
L["Rename Layout"] = "Layout umbenennen"
L["Rename Panel"] = "Panel umbenennen"
L["Right"] = "Rechts"
L["Right background inset."] = "Rechter Hintergrund"
L["Rotate"] = "Rotieren"
...
L["Size of each tile."] = "Größe jedes Titels"
...
L["This is the name as it will appear in drops down menus and the side tab."] = "Dies ist der Name, wie er im Drop-Down-Menü und der Registerkarte angezeigt wird." -- Needs review
...
L["This will import a layout into your configuration."] = "Dies importiert ein Layout in deine Configuration"
L["This will toggle SetTexCoordModifiesRect."] = "Umschalten des SetTexCoordModifiesRect."
L["Tile Background"] = "Hintergrund teilen" -- Needs review
L["Tile Size"] = "Titel Größe"
L["Tile the background horizontally."] = "Teile den Hintergrund Horizontal."
...
L["Tile the background vertically."] = "Teile den Hintergrund Vertikal."
...
L["URx"] = "URx"
L["URy"] = "URy"
L["Use custom TexCoords. This is an adavance feature."] = "Nutze eigene Textur Koordinaten. Dies ist ein fortgeschrittenes Feature."
...
L["X Offset"] = "X Offset"
L["X offset from center. NOTE: postive for up, negative for down."] = "X Offset von der Mitte. Anmerkung: Positiv für nach oben, negativ für nach unten."
L["X offsetting, positive for right, negative for left."] = "X offset. Anmerkung: Positiv für nach rechts, negativ für nach links"
L["Y Offset"] = "Y Offset"
L["Y offset. NOTE: positive for right, negative for left."] = "Y Offset. Anmerkung: Positiv für nach rechts, negativ für nach links"
L["Y offsetting, positive for up, negative for down."] = "Y Offset. Anmerkung: Positiv für nach oben, negativ für nach unten"
