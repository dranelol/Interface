				...
				if spellID == 7001 or spellID == 126154 then -- LIGHTWELL RENEW
					...
					if RSA.db.profile.Priest.Spells.LightwellRenew.Messages.Start ~= "" then
						...
						if RSA.db.profile.Priest.Spells.LightwellRenew.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Priest.Spells.LightwellRenew.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Priest.Spells.LightwellRenew.Party == true then
							if RSA.db.profile.Priest.Spells.LightwellRenew.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Priest.Spells.LightwellRenew.Raid == true then
							if RSA.db.profile.Priest.Spells.LightwellRenew.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 15487 and RSA_Silenced == false then -- SILENCE
					...
					if RSA.db.profile.Priest.Spells.Silence.Messages.Debuff ~= "" then
						...
						if RSA.db.profile.Priest.Spells.Silence.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Priest.Spells.Silence.Messages.Debuff, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Priest.Spells.Silence.Party == true then
							if RSA.db.profile.Priest.Spells.Silence.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Priest.Spells.Silence.Raid == true then
							if RSA.db.profile.Priest.Spells.Silence.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_AURA_REFRESH" then
				if spellID == 7001 or spellID == 126154 then -- LIGHTWELL RENEW
					...
					if RSA.db.profile.Priest.Spells.LightwellRenew.Messages.End ~= "" then
						...
						if RSA.db.profile.Priest.Spells.LightwellRenew.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Priest.Spells.LightwellRenew.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Priest.Spells.LightwellRenew.Party == true then
							if RSA.db.profile.Priest.Spells.LightwellRenew.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.Priest.Spells.GuardianSpirit.Messages.End ~= "" then
						...
						local function GSTimer(self, elapsed)
							...
							if RSA.db.profile.Priest.Spells.GuardianSpirit.Smart.RaidParty == true then
								RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Priest.Spells.GuardianSpirit.Messages.End, ".%a+.", RSA.String_Replace))
							end
							if RSA.db.profile.Priest.Spells.GuardianSpirit.Party == true then
								if RSA.db.profile.Priest.Spells.GuardianSpirit.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							...
							if RSA.db.profile.Priest.Spells.GuardianSpirit.Raid == true then
								if RSA.db.profile.Priest.Spells.GuardianSpirit.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
					...
					if RSA.db.profile.Priest.Spells.PowerWordBarrier.Messages.End ~= "" then
						...
						local function PWBTimer(self, elapsed)
							...
							if RSA.db.profile.Priest.Spells.PowerWordBarrier.Smart.RaidParty == true then
								RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Priest.Spells.PowerWordBarrier.Messages.End, ".%a+.", RSA.String_Replace))
							end
							if RSA.db.profile.Priest.Spells.PowerWordBarrier.Party == true then
								if RSA.db.profile.Priest.Spells.PowerWordBarrier.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							...
							if RSA.db.profile.Priest.Spells.PowerWordBarrier.Raid == true then
								if RSA.db.profile.Priest.Spells.PowerWordBarrier.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 724 or spellID == 126135 then -- LIGHTWELL
					...
					if RSA.db.profile.Priest.Spells.Lightwell.Messages.Start ~= "" then
						...
						if RSA.db.profile.Priest.Spells.Lightwell.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Priest.Spells.Lightwell.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Priest.Spells.Lightwell.Party == true then
							if RSA.db.profile.Priest.Spells.Lightwell.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Priest.Spells.Lightwell.Raid == true then
							if RSA.db.profile.Priest.Spells.Lightwell.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_HEAL" then
				if spellID == 48153 then -- GUARDIAN SPIRIT
					...
					if RSA.db.profile.Priest.Spells.GuardianSpirit.Messages.Proc ~= "" then
						...
						if RSA.db.profile.Priest.Spells.GuardianSpirit.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Priest.Spells.GuardianSpirit.Messages.Proc, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Priest.Spells.GuardianSpirit.Party == true then
							if RSA.db.profile.Priest.Spells.GuardianSpirit.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 605 and dest ~= pName then -- MIND CONTROL
					...
					if RSA.db.profile.Priest.Spells.MindControl.Messages.End ~= "" then
						...
						if RSA.db.profile.Priest.Spells.MindControl.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Priest.Spells.MindControl.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Priest.Spells.MindControl.Party == true then
							if RSA.db.profile.Priest.Spells.MindControl.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Priest.Spells.MindControl.Raid == true then
							if RSA.db.profile.Priest.Spells.MindControl.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 8122 and RSA_PsychicScream == false then -- PSYCHIC SCREAM
					...
					if RSA.db.profile.Priest.Spells.PsychicScream.Messages.End ~= "" then
						...
						if RSA.db.profile.Priest.Spells.PsychicScream.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Priest.Spells.PsychicScream.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Priest.Spells.PsychicScream.Party == true then
							if RSA.db.profile.Priest.Spells.PsychicScream.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Priest.Spells.PsychicScream.Raid == true then
							if RSA.db.profile.Priest.Spells.PsychicScream.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_INTERRUPT" then
				if spellID == 32747 then -- SILENCE
					...
					if RSA.db.profile.Priest.Spells.Silence.Messages.Start ~= "" then
						...
						if RSA.db.profile.Priest.Spells.Silence.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Priest.Spells.Silence.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Priest.Spells.Silence.Party == true then
							if RSA.db.profile.Priest.Spells.Silence.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if spell == GetSpellInfo(2006) and RSA.db.profile.Priest.Spells.Resurrection.Messages.Start ~= "" then -- RESURRECTION
				if event == "UNIT_SPELLCAST_SENT" then
					...
					if RSA.db.profile.Priest.Spells.Resurrection.Messages.Start ~= "" then
						...
						if RSA.db.profile.Priest.Spells.Resurrection.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Priest.Spells.Resurrection.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Priest.Spells.Resurrection.Party == true then
							if RSA.db.profile.Priest.Spells.Resurrection.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Priest.Spells.Resurrection.Raid == true then
							if RSA.db.profile.Priest.Spells.Resurrection.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				elseif event == "UNIT_SPELLCAST_SUCCEEDED" and Ressed ~= true then
					...
					if RSA.db.profile.Priest.Spells.Resurrection.Messages.End ~= "" then
						...
						if RSA.db.profile.Priest.Spells.Resurrection.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Priest.Spells.Resurrection.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Priest.Spells.Resurrection.Party == true then
							if RSA.db.profile.Priest.Spells.Resurrection.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
