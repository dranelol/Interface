				...
				if spellID == 19647 or spellID == 132409 or spellID == 115781 then -- SPELL LOCK / OPTICAL BLAST
					...
					if RSA.db.profile.Warlock.Spells.SpellLock.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warlock.Spells.SpellLock.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warlock.Spells.SpellLock.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warlock.Spells.SpellLock.Party == true then
							if RSA.db.profile.Warlock.Spells.SpellLock.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warlock.Spells.SpellLock.Raid == true then
							if RSA.db.profile.Warlock.Spells.SpellLock.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_MISSED" and missType ~= "IMMUNE" then
				if spellID == 24259 or spellID == 115782 then -- SPELL LOCK / OPTICAL BLAST
					...
					if RSA.db.profile.Warlock.Spells.SpellLock.Messages.End ~= "" then
						...
						if RSA.db.profile.Warlock.Spells.SpellLock.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warlock.Spells.SpellLock.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warlock.Spells.SpellLock.Party == true then
							if RSA.db.profile.Warlock.Spells.SpellLock.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 17735 then -- SUFFERING
					...
					if RSA.db.profile.Warlock.Spells.Suffering.Messages.End ~= "" then
						...
						if RSA.db.profile.Warlock.Spells.Suffering.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warlock.Spells.Suffering.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warlock.Spells.Suffering.Party == true then
							if RSA.db.profile.Warlock.Spells.Suffering.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warlock.Spells.Suffering.Raid == true then
							if RSA.db.profile.Warlock.Spells.Suffering.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 115284 then -- CLONE MAGIC
					...
					if RSA.db.profile.Warlock.Spells.CloneMagic.Messages.End ~= "" then
						...
						if RSA.db.profile.Warlock.Spells.CloneMagic.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Warlock.Spells.CloneMagic.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warlock.Spells.CloneMagic.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warlock.Spells.CloneMagic.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warlock.Spells.CloneMagic.Party == true then
							if RSA.db.profile.Warlock.Spells.CloneMagic.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warlock.Spells.CloneMagic.Raid == true then
							if RSA.db.profile.Warlock.Spells.CloneMagic.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_MISSED" and missType == "IMMUNE" then
				if spellID == 24259 or spellID == 115782 then -- SPELL LOCK / OPTICAL BLAST
					...
					if RSA.db.profile.Warlock.Spells.SpellLock.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Warlock.Spells.SpellLock.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warlock.Spells.SpellLock.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warlock.Spells.SpellLock.Party == true then
							if RSA.db.profile.Warlock.Spells.SpellLock.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 710 then -- BANISH
					...
					if RSA.db.profile.Warlock.Spells.Banish.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Warlock.Spells.Banish.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warlock.Spells.Banish.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warlock.Spells.Banish.Party == true then
							if RSA.db.profile.Warlock.Spells.Banish.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warlock.Spells.Banish.Raid == true then
							if RSA.db.profile.Warlock.Spells.Banish.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 5782 then -- FEAR
					...
					if RSA.db.profile.Warlock.Spells.Fear.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Warlock.Spells.Fear.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warlock.Spells.Fear.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warlock.Spells.Fear.Party == true then
							if RSA.db.profile.Warlock.Spells.Fear.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warlock.Spells.Fear.Raid == true then
							if RSA.db.profile.Warlock.Spells.Fear.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 17735 then -- SUFFERING
					...
					if RSA.db.profile.Warlock.Spells.Suffering.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Warlock.Spells.Suffering.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warlock.Spells.Suffering.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warlock.Spells.Suffering.Party == true then
							if RSA.db.profile.Warlock.Spells.Suffering.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 115284 then -- CLONE MAGIC
					...
					if RSA.db.profile.Warlock.Spells.CloneMagic.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Warlock.Spells.CloneMagic.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warlock.Spells.CloneMagic.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warlock.Spells.CloneMagic.Party == true then
							if RSA.db.profile.Warlock.Spells.CloneMagic.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if event == "UNIT_SPELLCAST_SENT" and UnitIsPlayer(dest) then
					...
					if RSA.db.profile.Warlock.Spells.Soulstone.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warlock.Spells.Soulstone.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warlock.Spells.Soulstone.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warlock.Spells.Soulstone.Party == true then
							if RSA.db.profile.Warlock.Spells.Soulstone.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warlock.Spells.Soulstone.Raid == true then
							if RSA.db.profile.Warlock.Spells.Soulstone.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
