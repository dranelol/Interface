...
La.Messages = {
	...
	-- ["%s about to expire!"] = "",
	["Sanctuary is assigned in Pally Power but no one has the spec to do it."] = "Salvaguardia esta asignado en Pally Power pero nadie tiene la especialización para usarlo.",
	Scan = "Escanear",
	...
	Spi = "Esp",
	Sta = "Agu",
	["Stamina increased by 60"] = "aguante aumentado en 60",
	["Stamina increased by 90"] = "Aguante aumentado en 90",
	Str = "Fue",
