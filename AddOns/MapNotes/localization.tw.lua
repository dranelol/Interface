...
-- %%% MAPNOTES_SENDTOPARTY_TIP = "Left Click to Party\nRight Click to Raid";
	...
	MAPNOTES_DECLINE_NOTETOONEAR = "|cFFFFD100%s|r 試圖給你發送一個在 |cFFFFD100%s|r 的標記, 但是它太接近 |cFFFFD100%q|r 了.";
	MAPNOTES_QUICKNOTE_NOTETOONEAR = "無法創建標記. 你太接近 |cFFFFD100%s|r 了.";
	...
	MAPNOTES_QUICKTLOC_NOTETOONEAR = "無法創建標記. 位置太接近標記 |cFFFFD100%s|r 了.";
	...
	MAPNOTES_THOTTBOTLOC = "Thottbot �標";
...
MAPNOTES_NETHERSTORMARENA = "暴風之眼";
MAPNOTES_STRANDOFTHEANCIENTS= "遠祖灘頭";
MAPNOTES_SCARLETENCLAVE = "東瘟疫之地: 血色領區";

	MAPNOTES_COSMIC = "宇宙地圖";
	...
	MAPNOTES_LM_CREATED = " MapNotes Crated in ";
