...
if GetLocale() == "koKR" then
	...
	MAPNOTES_SEND_TIP = MAPNOTES_DISPLAY.." 기능을 사용하는 사용자들에게 메모를 보낼 수 있습니다.";
...
-- %%% MAPNOTES_SENDTOPARTY_TIP = "Left Click - Party\nRight Click - Raid";
	...
	MAPNOTES_DECLINE_NOTETOONEAR = "|cFFFFD100%s|r님께서 당신에게 |cFFFFD100%s|r지역에 메모를 보냈습니다, 하지만 |cFFFFD100%q|r 메모와 자리가 겹쳐 생성하지 못했습니다.";
	MAPNOTES_QUICKNOTE_NOTETOONEAR = "메모를 만들 수 없습니다. |cFFFFD100%s|r 메모와 너무 가까운 곳에 있습니다.";
	...
	MAPNOTES_QUICKTLOC_NOTETOONEAR = "메모를 만들 수 없습니다. 지정한 ��치가 |cFFFFD100%s|r 메모에 너무 가깝습니다.";
	...
	MAPNOTES_NETHERSTORMARENA = "폭풍의 눈";
	MAPNOTES_STRANDOFTHEANCIENTS= "고대의 해안";
	MAPNOTES_SCARLETENCLAVE = "동부 역병지대: 붉은십자군 초소";

	MAPNOTES_COSMIC = "세계 지도";
	...
	MAPNOTES_LANDMARKS_CHECK = "uto-MapNote "..MAPNOTES_LANDMARKS;
