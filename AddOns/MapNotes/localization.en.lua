...
MAPNOTES_SEND_TIP = "These notes can be received by all "..MAPNOTES_DISPLAY.." users.";
...
MAPNOTES_CHAT_COMMAND_IMPORT_METAMAP =
    [[Imports MetaMapNotes. Intended for people migrating to MapNotes.\n]]..
...
MAPNOTES_CHAT_COMMAND_ICONALPHA = "Change Icon Alpha Level";
...
MAPNOTES_DECLINE_NOTETOONEAR = "|cFFFFD100%s|r tried to send you a note in |cFFFFD100%s|r, but it was too near to |cFFFFD100%q|r.";
MAPNOTES_QUICKNOTE_NOTETOONEAR = "Can't create note. You are too near to |cFFFFD100%s|r.";
...
MAPNOTES_QUICKTLOC_NOTETOONEAR = "Can't create note. The location is too near to the note |cFFFFD100%s|r.";
...
MAPNOTES_NETHERSTORMARENA = "Eye of the Storm";
MAPNOTES_STRANDOFTHEANCIENTS= "Strand of the Ancients";
MAPNOTES_SCARLETENCLAVE = "Plaguelands: The Scarlet Enclave";

MAPNOTES_COSMIC = "Cosmic map";
...
MN_DUPS_IGNORED = "Duplicates Ignored";
