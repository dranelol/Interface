...
function AtlasLootPVPSetMenu()
    ...
    --Druid
    AtlasLootMenuItem_3_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["DRUID"]);
    ...
    --Mage
    AtlasLootMenuItem_4_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["MAGE"]);
    AtlasLootMenuItem_4_Extra:SetText("");
    AtlasLootMenuItem_4_Icon:SetTexture("Interface\\Icons\\Spell_Frost_IceStorm");
    AtlasLootMenuItem_4.lootpage="PVPMage";
    AtlasLootMenuItem_4:Show();
    --Priest
    AtlasLootMenuItem_5_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["PRIEST"]);
    ...
    --Shaman
    AtlasLootMenuItem_6_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["SHAMAN"]);
    ...
    --Warrior
    AtlasLootMenuItem_7_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["WARRIOR"]);
    AtlasLootMenuItem_7_Extra:SetText("");
    AtlasLootMenuItem_7_Icon:SetTexture("Interface\\Icons\\INV_Shield_05");
    AtlasLootMenuItem_7.lootpage="PVPWarrior";
    AtlasLootMenuItem_7:Show();
    --Hunter
    AtlasLootMenuItem_18_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["HUNTER"]);
    ...
    --Paladin
    AtlasLootMenuItem_19_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["PALADIN"]);
    ...
    --Rogue
    AtlasLootMenuItem_20_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["ROGUE"]);
    AtlasLootMenuItem_20_Extra:SetText("");
    AtlasLootMenuItem_20_Icon:SetTexture("Interface\\Icons\\Ability_BackStab");
    AtlasLootMenuItem_20.lootpage="PVPRogue";
    AtlasLootMenuItem_20:Show();
    --Warlock
    AtlasLootMenuItem_21_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["WARLOCK"]);
...
function AtlasLootARENASetMenu()
    ...
    AtlasLootMenuItem_3:Show();
    --Druid Feral
    AtlasLootMenuItem_4_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["DRUID"]);
    ...
    AtlasLootMenuItem_4:Show();
    --Druid Restoration
    AtlasLootMenuItem_5_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["DRUID"]);
    ...
    --Paladin Protection
    AtlasLootMenuItem_12_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["PALADIN"]);
    ...
    --Paladin Retribution
    AtlasLootMenuItem_13_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["PALADIN"]);
    ...
    --Priest Holy
    AtlasLootMenuItem_17_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["PRIEST"]);
    ...
    --Priest Shadow
    AtlasLootMenuItem_18_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["PRIEST"]);
    ...
    AtlasLootMenuItem_20:Show();
    --Shaman Elemental
    AtlasLootMenuItem_22_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["SHAMAN"]);
    ...
    --Shaman Enhancement
    AtlasLootMenuItem_23_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["SHAMAN"]);
    ...
    --Shaman Restoration
    AtlasLootMenuItem_24_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["SHAMAN"]);
    ...
    --Warlock Demonology
    AtlasLootMenuItem_26_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["WARLOCK"]);
    ...
    --Warlock Destruction
    AtlasLootMenuItem_27_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["WARLOCK"]);
    ...
    --Warrior
    AtlasLootMenuItem_29_Name:SetText(LOCALIZED_CLASS_NAMES_MALE["WARRIOR"]);
