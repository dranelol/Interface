...
local RSA_FE_GUID,RSA_EE_GUID,RSA_MT_GUID,RSA_HT_GUID,RSA_SL_GUID,RSA_TREMOR_GUID,RSA_GROUNDING_GUID,RSA_STORMLASH_GUID,RSA_WINDWALK_GUID,RSA_CAPACITOR_GUID
	...
	local function Shaman_Spells(self, _, timestamp, event, hideCaster, sourceGUID, source, sourceFlags, sourceRaidFlag, destGUID, dest, destFlags, destRaidFlags, spellID, spellName, spellSchool, missType, ex2, ex3, ex4)
		...
		if source == pName or source == petName then
			...
			if event == "SPELL_AURA_APPLIED" then
				if spellID == 114049 and GetSpecialization() == 3 then -- ASCENDANCE
					...
					if RSA.db.profile.Shaman.Spells.Ascendance.Messages.Start ~= "" then
						...
						if RSA.db.profile.Shaman.Spells.Ascendance.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Shaman.Spells.Ascendance.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.Ascendance.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.Ascendance.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.Ascendance.Party == true then
							if RSA.db.profile.Shaman.Spells.Ascendance.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Shaman.Spells.Ascendance.Raid == true then
							if RSA.db.profile.Shaman.Spells.Ascendance.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 57994 then -- WIND SHEAR
					...
					if RSA.db.profile.Shaman.Spells.WindShear.Messages.Start ~= "" then
						...
						if RSA.db.profile.Shaman.Spells.WindShear.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.WindShear.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.WindShear.Party == true then
							if RSA.db.profile.Shaman.Spells.WindShear.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Shaman.Spells.WindShear.Raid == true then
							if RSA.db.profile.Shaman.Spells.WindShear.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_MISSED" and missType ~= "IMMUNE" then
				if spellID == 57994 then -- WIND SHEAR
					...
					if RSA.db.profile.Shaman.Spells.WindShear.Messages.End ~= "" then
						...
						if RSA.db.profile.Shaman.Spells.WindShear.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.WindShear.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.WindShear.Party == true then
							if RSA.db.profile.Shaman.Spells.WindShear.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_MISSED" and missType == "IMMUNE" then
				if spellID == 57994 then -- WIND SHEAR
					...
					if RSA.db.profile.Shaman.Spells.WindShear.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Shaman.Spells.WindShear.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.WindShear.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.WindShear.Party == true then
							if RSA.db.profile.Shaman.Spells.WindShear.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_SUMMON" then
				...
				if spellID == 120668 then -- STORMLASH TOTEM
					RSA_STORMLASH_GUID = destGUID return
				end -- STORMLASH TOTEM
			...
			if event == "UNIT_DESTROYED" then
				if destGUID == RSA_MT_GUID then -- MANA TIDE TOTEM
					...
					if RSA.db.profile.Shaman.Spells.ManaTide.Messages.End ~= "" then
						if RSA.db.profile.Shaman.Spells.ManaTide.Local == true then
							RSA.Print_LibSink(string.gsub(RSA.db.profile.Shaman.Spells.ManaTide.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.ManaTide.Yell == true then
							RSA.Print_Yell(string.gsub(RSA.db.profile.Shaman.Spells.ManaTide.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.ManaTide.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Shaman.Spells.ManaTide.Messages.End, ".%a+.", RSA.String_Replace), RSA.db.profile.Shaman.Spells.ManaTide.CustomChannel.Channel)
						end
						if RSA.db.profile.Shaman.Spells.ManaTide.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Shaman.Spells.ManaTide.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.ManaTide.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.ManaTide.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.ManaTide.Party == true then
							if RSA.db.profile.Shaman.Spells.ManaTide.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							RSA.Print_Party(string.gsub(RSA.db.profile.Shaman.Spells.ManaTide.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.ManaTide.Raid == true then
							if RSA.db.profile.Shaman.Spells.ManaTide.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Shaman.Spells.ManaTide.Messages.End, ".%a+.", RSA.String_Replace))
						end
					end
				end -- MANA TIDE TOTEM
				if destGUID == RSA_EE_GUID then -- EARTH ELEMENTAL TOTEM
					...
					if RSA.db.profile.Shaman.Spells.EarthElementalTotem.Messages.End ~= "" then
						...
						if RSA.db.profile.Shaman.Spells.EarthElementalTotem.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Shaman.Spells.EarthElementalTotem.Messages.End, ".%a+.", RSA.String_Replace), RSA.db.profile.Shaman.Spells.ManaTide.CustomChannel.Channel)
						end
						if RSA.db.profile.Shaman.Spells.EarthElementalTotem.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Shaman.Spells.EarthElementalTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.EarthElementalTotem.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.EarthElementalTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.EarthElementalTotem.Party == true then
							if RSA.db.profile.Shaman.Spells.EarthElementalTotem.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Shaman.Spells.EarthElementalTotem.Raid == true then
							if RSA.db.profile.Shaman.Spells.EarthElementalTotem.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if destGUID == RSA_FE_GUID then -- FIRE ELEMENTAL TOTEM
					...
					if RSA.db.profile.Shaman.Spells.FireElementalTotem.Messages.End ~= "" then
						...
						if RSA.db.profile.Shaman.Spells.FireElementalTotem.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Shaman.Spells.FireElementalTotem.Messages.End, ".%a+.", RSA.String_Replace), RSA.db.profile.Shaman.Spells.ManaTide.CustomChannel.Channel)
						end
						if RSA.db.profile.Shaman.Spells.FireElementalTotem.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Shaman.Spells.FireElementalTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.FireElementalTotem.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.FireElementalTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.FireElementalTotem.Party == true then
							if RSA.db.profile.Shaman.Spells.FireElementalTotem.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Shaman.Spells.FireElementalTotem.Raid == true then
							if RSA.db.profile.Shaman.Spells.FireElementalTotem.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if destGUID == RSA_HT_GUID then -- HEALING TIDE TOTEM
					...
					if RSA.db.profile.Shaman.Spells.HealingTide.Messages.End ~= "" then
						...
						if RSA.db.profile.Shaman.Spells.HealingTide.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Shaman.Spells.HealingTide.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.HealingTide.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.HealingTide.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.HealingTide.Party == true then
							if RSA.db.profile.Shaman.Spells.HealingTide.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Shaman.Spells.HealingTide.Raid == true then
							if RSA.db.profile.Shaman.Spells.HealingTide.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if destGUID == RSA_SL_GUID then -- SPIRIT LINK TOTEM
					...
					if RSA.db.profile.Shaman.Spells.SpiritLink.Messages.End ~= "" then
						...
						if RSA.db.profile.Shaman.Spells.SpiritLink.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.SpiritLink.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.SpiritLink.Party == true then
							if RSA.db.profile.Shaman.Spells.SpiritLink.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Shaman.Spells.SpiritLink.Raid == true then
							if RSA.db.profile.Shaman.Spells.SpiritLink.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if destGUID == RSA_TREMOR_GUID then -- TREMOR TOTEM
					...
					if RSA.db.profile.Shaman.Spells.TremorTotem.Messages.End ~= "" then
						...
						if RSA.db.profile.Shaman.Spells.TremorTotem.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.TremorTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.TremorTotem.Party == true then
							if RSA.db.profile.Shaman.Spells.TremorTotem.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Shaman.Spells.TremorTotem.Raid == true then
							if RSA.db.profile.Shaman.Spells.TremorTotem.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Shaman.Spells.TremorTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
					end
				end -- TREMOR TOTEM
				if destGUID == RSA_STORMLASH_GUID then -- STORMLASH TOTEM
					spellinfo = GetSpellInfo(120668) spelllinkinfo = GetSpellLink(120668)
					RSA.Replacements = {["[SPELL]"] = spellinfo, ["[LINK]"] = spelllinkinfo,}
					if RSA.db.profile.Shaman.Spells.StormlashTotem.Messages.End ~= "" then
						if RSA.db.profile.Shaman.Spells.StormlashTotem.Local == true then
							RSA.Print_LibSink(string.gsub(RSA.db.profile.Shaman.Spells.StormlashTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.StormlashTotem.Yell == true then
							RSA.Print_Yell(string.gsub(RSA.db.profile.Shaman.Spells.StormlashTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.StormlashTotem.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Shaman.Spells.StormlashTotem.Messages.End, ".%a+.", RSA.String_Replace), RSA.db.profile.Shaman.Spells.StormlashTotem.CustomChannel.Channel)
						end
						if RSA.db.profile.Shaman.Spells.StormlashTotem.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Shaman.Spells.StormlashTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.StormlashTotem.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.StormlashTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.StormlashTotem.Party == true then
							if RSA.db.profile.Shaman.Spells.StormlashTotem.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							RSA.Print_Party(string.gsub(RSA.db.profile.Shaman.Spells.StormlashTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.StormlashTotem.Raid == true then
							if RSA.db.profile.Shaman.Spells.StormlashTotem.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Shaman.Spells.StormlashTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
					end
				end -- STORMLASH TOTEM
				if destGUID == RSA_WINDWALK_GUID then -- WINDWALK TOTEM
					...
					if RSA.db.profile.Shaman.Spells.WindwalkTotem.Messages.End ~= "" then
						...
						if RSA.db.profile.Shaman.Spells.WindwalkTotem.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Shaman.Spells.WindwalkTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.WindwalkTotem.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.WindwalkTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.WindwalkTotem.Party == true then
							if RSA.db.profile.Shaman.Spells.WindwalkTotem.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Shaman.Spells.WindwalkTotem.Raid == true then
							if RSA.db.profile.Shaman.Spells.WindwalkTotem.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if destGUID == RSA_CAPACITOR_GUID then -- CAPACITOR TOTEM
					...
					if RSA.db.profile.Shaman.Spells.CapacitorTotem.Messages.End ~= "" then
						...
						if RSA.db.profile.Shaman.Spells.CapacitorTotem.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Shaman.Spells.CapacitorTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.CapacitorTotem.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.CapacitorTotem.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.CapacitorTotem.Party == true then
							if RSA.db.profile.Shaman.Spells.CapacitorTotem.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Shaman.Spells.CapacitorTotem.Raid == true then
							if RSA.db.profile.Shaman.Spells.CapacitorTotem.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
		...
		if destGUID == RSA_GROUNDING_GUID and event ~= "SPELL_SUMMON" and event ~= "UNIT_DESTROYED" and event ~= "SPELL_MISSED" and event ~= "PARTY_KILL" and event ~= "UNIT_DIED" then -- GROUNDING TOTEM
			...
			if RSA.db.profile.Shaman.Spells.GroundingTotem.Messages.End ~= "" then
				...
				if RSA.db.profile.Shaman.Spells.GroundingTotem.Smart.RaidParty == true then
					RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.GroundingTotem.Messages.End, ".%a+.", RSA.String_Replace))
				end
				if RSA.db.profile.Shaman.Spells.GroundingTotem.Party == true then
					if RSA.db.profile.Shaman.Spells.GroundingTotem.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if RSA.db.profile.Shaman.Spells.GroundingTotem.Raid == true then
					if RSA.db.profile.Shaman.Spells.GroundingTotem.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
		...
		if destGUID == RSA_GROUNDING_GUID and event == "SPELL_MISSED" and missType == "IMMUNE" then -- GROUNDING TOTEM
			...
			if RSA.db.profile.Shaman.Spells.GroundingTotem.Messages.Immune ~= "" then
				...
				if RSA.db.profile.Shaman.Spells.GroundingTotem.Smart.RaidParty == true then
					RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.GroundingTotem.Messages.Immune, ".%a+.", RSA.String_Replace))
				end
				if RSA.db.profile.Shaman.Spells.GroundingTotem.Party == true then
					if RSA.db.profile.Shaman.Spells.GroundingTotem.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if spell == GetSpellInfo(2008) and RSA.db.profile.Shaman.Spells.AncestralSpirit.Messages.Start ~= "" then -- ANCESTRAL SPIRIT
				if event == "UNIT_SPELLCAST_SENT" then
					...
					if RSA.db.profile.Shaman.Spells.AncestralSpirit.Messages.Start ~= "" then
						...
						if RSA.db.profile.Shaman.Spells.AncestralSpirit.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.AncestralSpirit.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.AncestralSpirit.Party == true then
							if RSA.db.profile.Shaman.Spells.AncestralSpirit.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Shaman.Spells.AncestralSpirit.Raid == true then
							if RSA.db.profile.Shaman.Spells.AncestralSpirit.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				elseif event == "UNIT_SPELLCAST_SUCCEEDED" and Ressed ~= true then
					...
					if RSA.db.profile.Shaman.Spells.AncestralSpirit.Messages.End ~= "" then
						...
						if RSA.db.profile.Shaman.Spells.AncestralSpirit.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Shaman.Spells.AncestralSpirit.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Shaman.Spells.AncestralSpirit.Party == true then
							if RSA.db.profile.Shaman.Spells.AncestralSpirit.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
