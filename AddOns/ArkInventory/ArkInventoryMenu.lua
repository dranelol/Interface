...
--		)
	...
	if ( level == 2 + offset ) and value then
			...
			for companionIndex = 1, n do
				...
				if companionData.usable[mountType] and ( ( mountType == "l" and ArkInventory.Global.Me.ldb.mounts.l.useflying ) or ( companionData.mt == mountType ) ) then
			...
			if mountType == "l" then
					...
					ArkInventory.Lib.Dewdrop:AddLine(
						"text", ArkInventory.Localise["LDB_MOUNTS_LAND_USEFLYING"],
						"tooltipTitle", ArkInventory.Localise["LDB_MOUNTS_LAND_USEFLYING"],
						"tooltipText", ArkInventory.Localise["LDB_MOUNTS_LAND_USEFLYING_TEXT"],
