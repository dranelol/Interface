...
L["Click this button to send off the item to the specified character."] = "Нажмите, чтобы отправить предметы."
...
L["Collected sale of %s (%d) for %s."] = "Получено за продажу %s (%d) за %s."
