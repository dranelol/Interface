...
function RSA.AnnouncementCheck() -- Checks against user settings to see if we are allowed to announce.
	...
	if RSA.db.profile.General.GlobalAnnouncements.InLFG and IsPartyLFG("player") == 1 then return true end
	return false
end
...
function RSA.Print_Smart_RaidParty(message) -- Send a message to battleground, raid, party, or nothing, depending on group size or location.
	local InInstance, InstanceType = IsInInstance()
	local Announced = false
	if RSA.AnnouncementCheck() == true then
		-- If player is in LFG / LFR / Scenario
		if IsPartyLFG("player") == 1 then
...
function RSA.Print_Raid(message) -- Send a message to raid or nothing. Additionally, will not try to send a message if in a Battleground or Arena.
	local InInstance, InstanceType = IsInInstance()
	if RSA.AnnouncementCheck() == true and IsPartyLFG("player") ~= 1 then
		if IsInRaid() == true and GetNumGroupMembers() > 0 and InstanceType ~= "pvp" and InstanceType ~= "arena" then
			SendChatMessage(format(message), "RAID", nil)
		end
	end
end
function RSA.Print_Party(message) -- Send a message to party or nothing. Additionally, will not try to send a message if in a Battleground.
	local InInstance, InstanceType = IsInInstance()
	if RSA.AnnouncementCheck() == true and IsPartyLFG("player") ~= 1 then
			...
			or spellID == 126497 or spellID == 126503 or spellID == 126501 or spellID == 126492) and RSA.CanAnnounce() then -- FEASTS
				...
				if RSA.db.profile.General.Spells.Feasts.Messages.Start ~= "" then
					...
					if RSA.db.profile.General.Spells.Feasts.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.Feasts.Messages.Start, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.Feasts.Party == true then
						if RSA.db.profile.General.Spells.Feasts.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.General.Spells.Feasts.Raid == true then
						if RSA.db.profile.General.Spells.Feasts.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if (spellID == 92712 or spellID == 92649) and RSA.CanAnnounce() then -- CAULDRON
				...
				if RSA.db.profile.General.Spells.Cauldron.Messages.Start ~= "" then
					...
					if RSA.db.profile.General.Spells.Cauldron.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.Cauldron.Messages.Start, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.Cauldron.Party == true then
						if RSA.db.profile.General.Spells.Cauldron.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.General.Spells.Cauldron.Raid == true then
						if RSA.db.profile.General.Spells.Cauldron.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if spellID == 83968 and source == pName then -- MASS RESURRECTION
				...
				if RSA.db.profile.General.Spells.MassRess.Messages.Start ~= "" then
					...
					if RSA.db.profile.General.Spells.MassRess.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.MassRess.Messages.Start, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.MassRess.Party == true then
						if RSA.db.profile.General.Spells.MassRess.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.General.Spells.MassRess.Raid == true then
						if RSA.db.profile.General.Spells.MassRess.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if spellID == 83958 and RSA.CanAnnounce() then -- MOBILE BANKING
				...
				if RSA.db.profile.General.Spells.MobileBank.Messages.Start ~= "" then
					...
					if RSA.db.profile.General.Spells.MobileBank.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.MobileBank.Messages.Start, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.MobileBank.Party == true then
						if RSA.db.profile.General.Spells.MobileBank.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.General.Spells.MobileBank.Raid == true then
						if RSA.db.profile.General.Spells.MobileBank.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if (spellID == 67826 or spellID == 44389 or spellID == 54711 or spellID == 22700) and RSA.CanAnnounce() then -- JEEVES
				...
				if RSA.db.profile.General.Spells.Jeeves.Messages.Start ~= "" then
					...
					if RSA.db.profile.General.Spells.Jeeves.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.Jeeves.Messages.Start, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.Jeeves.Party == true then
						if RSA.db.profile.General.Spells.Jeeves.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.General.Spells.Jeeves.Raid == true then
						if RSA.db.profile.General.Spells.Jeeves.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if (spellID == 28880 or spellID == 59547 or spellID == 59544 or spellID == 59542 or spellID == 59548 or spellID == 59543 or spellID == 59545) and source == pName then -- GIFT OF THE NAARU
				...
				if RSA.db.profile.General.Spells.GOTN.Messages.Start ~= "" then
					...
					if RSA.db.profile.General.Spells.GOTN.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.GOTN.Messages.Start, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.GOTN.Party == true then
						if RSA.db.profile.General.Spells.GOTN.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.General.Spells.GOTN.Raid == true then
						if RSA.db.profile.General.Spells.GOTN.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if spellID == 59752 and source == pName then -- EVERY MAN FOR HIMSELF
				...
				if RSA.db.profile.General.Spells.EMFH.Messages.Start ~= "" then
					...
					if RSA.db.profile.General.Spells.EMFH.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.EMFH.Messages.Start, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.EMFH.Party == true then
						if RSA.db.profile.General.Spells.EMFH.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.General.Spells.EMFH.Raid == true then
						if RSA.db.profile.General.Spells.EMFH.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if spellID == 20549 and source == pName then -- WARSTOMP
				...
				if RSA.db.profile.General.Spells.WarStomp.Messages.Start ~= "" then
					...
					if RSA.db.profile.General.Spells.WarStomp.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.WarStomp.Messages.Start, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.WarStomp.Party == true then
						if RSA.db.profile.General.Spells.WarStomp.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.General.Spells.WarStomp.Raid == true then
						if RSA.db.profile.General.Spells.WarStomp.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if spellID == 7744 and source == pName then -- WILL OF THE FORSAKEN
				...
				if RSA.db.profile.General.Spells.WOTF.Messages.Start ~= "" then
					...
					if RSA.db.profile.General.Spells.WOTF.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.WOTF.Messages.Start, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.WOTF.Party == true then
						if RSA.db.profile.General.Spells.WOTF.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.General.Spells.WOTF.Raid == true then
						if RSA.db.profile.General.Spells.WOTF.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if spellID == 20589 and source == pName then -- ESCAPE ARTIST
				...
				if RSA.db.profile.General.Spells.EscapeArtist.Messages.Start ~= "" then
					...
					if RSA.db.profile.General.Spells.EscapeArtist.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.EscapeArtist.Messages.Start, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.EscapeArtist.Party == true then
						if RSA.db.profile.General.Spells.EscapeArtist.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.General.Spells.EscapeArtist.Raid == true then
						if RSA.db.profile.General.Spells.EscapeArtist.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if (spellID == 78993 or spellID == 105701) and source == pName then -- POTION OF FOCUS / CONCENTRATION
				...
				if RSA.db.profile.General.Spells.PotionOfConcentration.Messages.Start ~= "" then
					...
					if RSA.db.profile.General.Spells.PotionOfConcentration.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.PotionOfConcentration.Messages.Start, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.PotionOfConcentration.Party == true then
						if RSA.db.profile.General.Spells.PotionOfConcentration.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.General.Spells.PotionOfConcentration.Raid == true then
						if RSA.db.profile.General.Spells.PotionOfConcentration.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if (spellID == 28730 or spellID == 50613 or spellID == 80483 or spellID == 25046 or spellID == 69179) and source == pName then -- ARCANE TORRENT
				...
				if RSA.db.profile.General.Spells.ArcaneTorrent.Messages.Start ~= "" then
					...
					if RSA.db.profile.General.Spells.ArcaneTorrent.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.ArcaneTorrent.Messages.Start, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.ArcaneTorrent.Party == true then
						if RSA.db.profile.General.Spells.ArcaneTorrent.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.General.Spells.ArcaneTorrent.Raid == true then
						if RSA.db.profile.General.Spells.ArcaneTorrent.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if spellID == 65116 and source == pName then -- STONEFORM
				...
				if RSA.db.profile.General.Spells.Stoneform.Messages.Start ~= "" then
					...
					if RSA.db.profile.General.Spells.Stoneform.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.Stoneform.Messages.Start, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.Stoneform.Party == true then
						if RSA.db.profile.General.Spells.Stoneform.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.General.Spells.Stoneform.Raid == true then
						if RSA.db.profile.General.Spells.Stoneform.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
		...
		if event == "SPELL_AURA_REMOVED" then
			if spellID == 59547 and source == pName then -- GIFT OF THE NAARU
				...
				if RSA.db.profile.General.Spells.GOTN.Messages.End ~= "" then
					...
					if RSA.db.profile.General.Spells.GOTN.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.GOTN.Messages.End, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.GOTN.Party == true then
						if RSA.db.profile.General.Spells.GOTN.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if spellID == 65116 and source == pName then -- STONEFORM
				...
				if RSA.db.profile.General.Spells.Stoneform.Messages.End ~= "" then
					...
					if RSA.db.profile.General.Spells.Stoneform.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.Stoneform.Messages.End, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.Stoneform.Party == true then
						if RSA.db.profile.General.Spells.Stoneform.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if (spellID == 78993 or spellID == 105701) and source == pName then -- POTION OF FOCUS / CONCENTRATION
				...
				if RSA.db.profile.General.Spells.PotionOfConcentration.Messages.End ~= "" then
					...
					if RSA.db.profile.General.Spells.PotionOfConcentration.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.PotionOfConcentration.Messages.End, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.General.Spells.PotionOfConcentration.Party == true then
						if RSA.db.profile.General.Spells.PotionOfConcentration.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
	...
	if event == "SPELL_AURA_REMOVED" then
	    if spellID == 68054 and botguids[destGUID] and RSA.CanAnnounce() then -- JEEVES
			...
			if RSA.db.profile.General.Spells.Jeeves.Messages.End ~= "" then
				...
				if RSA.db.profile.General.Spells.Jeeves.Smart.RaidParty == true then
					RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.General.Spells.Jeeves.Messages.End, ".%a+.", RSA.String_Replace))
				end
				if RSA.db.profile.General.Spells.Jeeves.Party == true then
					if RSA.db.profile.General.Spells.Jeeves.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
