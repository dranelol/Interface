local VERSION = tonumber(("$Revision: 1768 $"):match("%d+"))

local PitBull = PitBull
if PitBull.revision < VERSION then
	PitBull.version = "r" .. VERSION
	PitBull.revision = VERSION
	PitBull.date = ("$Date: 2008-11-01 14:35:41 +0000 (Sat, 01 Nov 2008) $"):match("%d%d%d%d%-%d%d%-%d%d")
end
...
local localization = (GetLocale() == "koKR") and {
	...
	["Percent"] = "Pourcentage",
	["RawPercent"] = "Pourcentage brut",
	["Colored Percent"] = "Pourcentage coloré",
	["Colored RawPercent"] = "Pourcentage brut coloré",
	["Mini"] = "Mini",
	["Smart"] = "Intelligent",
