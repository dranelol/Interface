local VERSION = tonumber(("$Revision: 1900 $"):match("%d+"))
...
PitBull.date = ("$Date: 2010-03-23 22:03:39 +0000 (Tue, 23 Mar 2010) $"):match("%d%d%d%d%-%d%d%-%d%d")
