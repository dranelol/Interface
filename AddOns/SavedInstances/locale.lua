...
Ld["Combine LFR/Flex"] = "Combine LFR/Flex"
...
La["Account"] = "Compte" -- Needs review
...
La["Always show new instances"] = "Montrer toujours les nouvelles instances" -- Needs review
La["Are you sure you want to reset the SavedInstances character database? Characters will be re-populated as you log into them."] = "Etes vous sûr de vouloir remettre à zéro votre base de données de personnages pour SavedInstances ? Les données des personnages seront re-récupérées au moment où vous les connecterez." -- Needs review
La["Attempt to recover completed daily quests for this character. Note this may recover some additional, linked daily quests that were not actually completed today."] = "Essayer de récupérer les quêtes journalières accomplies pour ce personnage. Notez que cela peut récupérer certaines quêtes supplémentaires liées qui n'ont pas été accomplies aujourd'hui." -- Needs review
La["Bind a key to toggle the SavedInstances tooltip"] = "Lier une touche à l'affichage du tooltip de SavedInstance"
...
La["Crops growing"] = "Cultures en cours de croissance" -- Needs review
La["Crops harvested today"] = "Cultures récoltées aujourd'hui" -- Needs review
La["Crops planted today"] = "Cultures plantées aujourd'hui" -- Needs review
La["Crops ready"] = "Cultures prêtes" -- Needs review
La["Daily Quests"] = "Quêtes journalières"
La["Disable mouseover"] = "Désactiver le survol avec la souris" -- Needs review
La["Disable tooltip display on icon mouseover"] = "Désactiver l'affichage de l'infobulle au survol de la souris" -- Needs review
...
La["Expansion"] = "Extension" -- Needs review
...
La["Facets of Research"] = "Facettes de recherche" -- Needs review
La["Farm Crops"] = "Cultures de la ferme" -- Needs review
La["Flex"] = "Dynamique" -- Needs review
La["General settings"] = "Options globales" -- Needs review
...
La["Instance options"] = "Options des instances" -- Needs review
La["Instances"] = "Instances"
La["Last updated"] = "Dernière mise à jour" -- Needs review
...
La["List raid categories before dungeon categories"] = "Liste les catégories de raid avant celles des donjons" -- Needs review
La["Lockouts"] = "Verouillages"
La["Members"] = "Membres"
La["Miscellaneous"] = "Divers"
La["Most recent first"] = "Les plus récents en premier"
La["Move down"] = "Déplacer vers le bas" -- Needs review
La["Move up"] = "Déplacer vers le haut" -- Needs review
La["Never show"] = "Ne jamais afficher" -- Needs review
La["Note"] = "Note"
La["Opacity of the tooltip row highlighting"] = "Opacité de l'infobulle de surbrillance de ligne" -- Needs review
La["Open config"] = "Ouvrir la configuration" -- Needs review
La["Plant"] = "Plantes" -- Needs review
...
La["Recover Dailies"] = "Récupérer les journalières" -- Needs review
-- La["Remind about weekly charm quest"] = ""
La["Reminder: You need to do quest %s"] = "Rappel : vous devez faire la quête %s" -- Needs review
La["Report instance resets to group"] = "Indiquer les reset d'instance au groupe"
La["Reset Characters"] = "Remise à zéro des personnages" -- Needs review
La["Reverse ordering"] = "Ordre inversé"
La["Row Highlight"] = "Surbrillance de ligne" -- Needs review
La["Seed"] = "Graine" -- Needs review
La["Seeds"] = "Graines" -- Needs review
La["Selected category"] = "Catégorie sélectionnée" -- Needs review
La["Selected character"] = "Personnage sélectionné"
La["Selected instance"] = "Instance sélectionnée" -- Needs review
La["Show category names"] = "Voir les noms des catégories" -- Needs review
La["Show category names in the tooltip"] = "Voir les noms des catégories dans le tooltip" -- Needs review
La["Show cooldown for characters to use battleground system"] = "Montrer le temps de recharge du système de Champs de Bataille" -- Needs review
La["Show cooldown for characters to use LFG dungeon system"] = "Montrer le temps de recharge du système de donjons LFG" -- Needs review
La["Show Expired"] = "Montrer les expirés"
La["Show expired instance lockouts"] = "Montrer les verrouillages d'instance expirés" -- Needs review
La["Show/Hide the SavedInstances tooltip"] = "Montrer/Cacher le tooltip de SavedInstances"
...
La["Show Holiday"] = "Montrer les vacances"
La["Show holiday boss rewards"] = "Montrer les récompenses des boss de vacances"
La["Show minimap button"] = "Afficher le bouton sur la minimap"
La["Show name for a category when all displayed instances belong only to that category"] = "Montrer le nom d'une catégorie quand toutes les instances affichées sont uniquement de ce type" -- Needs review
La["Show only current server"] = "Afficher uniquement le serveur actuel"
La["Show Random"] = "Afficher aléatoire" -- Needs review
La["Show random dungeon bonus reward"] = "Afficher les récompenses bonus des donjons aléatoires" -- Needs review
La["Show self always"] = "Toujours afficher soi-même" -- Needs review
La["Show self first"] = "Montrer soi-même en premier"
La["Show the SavedInstances minimap button"] = "Montrer le bouton de SavedInstances sur la minimap" -- Needs review
La["Show tooltip hints"] = "Montrer les astuces du tooltip"
La["Show when not saved"] = "Afficher quand non sauvegardé" -- Needs review
...
La["Similarly, the words KILLED and TOTAL will be substituted with the number of bosses killed and total in the lockout."] = "De la même manière, les mots KILLED et TOTAL seront remplacés par le nombre de boss tués et le total pour ce verrouillage." -- Needs review
La["Single category name"] = "Nom de catégorie unique " -- Needs review
...
La["Space between categories"] = "Espacer les catégories" -- Needs review
La["Text"] = "Texte"
...
La["Throw"] = "Lancer" -- Needs review
La["Time Left"] = [=[Temps restant
délai avant la réinitialisation de l'instance]=] -- Needs review
La["Tooltip Scale"] = "Taille de l'infobulle" -- Needs review
La["Track"] = "Suivre"
La["Track Battleground Deserter cooldown"] = "Suivre le le temps de recharge \"Déserteur\" des Champs de Bataille" -- Needs review
La["Track Daily Quests"] = "Suivre les quêtes journalières"
La["Track farm crops"] = "Suivre les récoltes de la ferme" -- Needs review
...
La["Track trade skill cooldowns"] = "Suivre les temps de recharge des métiers" -- Needs review
La["Track Weekly Quests"] = "Suivre les quêtes hebdomadaires"
La["Trade Skill Cooldowns"] = "Temps de recharge des métiers" -- Needs review
La["Transmute"] = "Transmutation" -- Needs review
...
La["Combine LFR/Flex"] = "LFR/Flex zusammenfassen"
...
-- La["Remind about weekly charm quest"] = ""
La["Reminder: You need to do quest %s"] = "Erinnerung: Du hast noch folgende quest %s zu erledigen." -- Needs review
...
La["Track"] = "Überwache"
La["Track Battleground Deserter cooldown"] = "Überwache Schlachtfeld-Deserteur-Abklingzeiten"
La["Track Daily Quests"] = "Verfolge tägliche Quests"
La["Track farm crops"] = "Verfolge Ackerbau Gesamternte"
La["Track LFG dungeon cooldown"] = "Überwache Dungeonbrowser Abklingzeiten"
La["Track random daily dungeon"] = "Überwache täglichen Zufalls-Dungeon"
...
La["Extended Lockout - Not yet saved"] = "연장된 귀속 - 아직 저장 않됨"
...
La["Combine LFR/Flex"] = "Объединять СПР/Гибкий"
...
La["Remind about weekly charm quest"] = "Напоминать об еженедельном получении амулетов" -- Needs review
La["Reminder: You need to do quest %s"] = "Напоминание: Вы ещё не выполнили %s" -- Needs review
...
La["Combine LFR/Flex"] = "合并 随机/弹性" -- Needs review
La["Combine World Bosses"] = "合并世界首领" -- Needs review
...
La["Remind about weekly charm quest"] = "对每周徽记任务情况的提醒" -- Needs review
La["Reminder: You need to do quest %s"] = "提醒: 你还没有完成任务 %s" -- Needs review
...
La["World Boss"] = "世界首领"
La["World Bosses"] = "世界首领" -- Needs review
...
La["Combine LFR/Flex"] = "合併 隨機團隊/彈性"
