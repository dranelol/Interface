	...
	local function Hunter_Spells(self, _, timestamp, event, hideCaster, sourceGUID, source, sourceFlags, sourceRaidFlag, destGUID, dest, destFlags, destRaidFlags, spellID, spellName, spellSchool, missType, ex2, ex3, ex4)
		...
		if source == pName or source == petName then
			...
			if event == "SPELL_AURA_APPLIED" then
				if spellID == 20736 then -- DISTRACTING SHOT
					...
					if RSA.db.profile.Hunter.Spells.DistractingShot.Messages.Start ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.DistractingShot.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.DistractingShot.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.DistractingShot.Party == true then
							if RSA.db.profile.Hunter.Spells.DistractingShot.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Hunter.Spells.DistractingShot.Raid == true then
							if RSA.db.profile.Hunter.Spells.DistractingShot.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 3355 then -- FREEZING TRAP
					...
					if RSA.db.profile.Hunter.Spells.FreezingTrap.Messages.Start ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.FreezingTrap.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.FreezingTrap.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.FreezingTrap.Party == true then
							if RSA.db.profile.Hunter.Spells.FreezingTrap.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Hunter.Spells.FreezingTrap.Raid == true then
							if RSA.db.profile.Hunter.Spells.FreezingTrap.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 19386 then -- WYVERN STING
					...
					if RSA.db.profile.Hunter.Spells.WyvernSting.Messages.Start ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.WyvernSting.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.WyvernSting.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.WyvernSting.Party == true then
							if RSA.db.profile.Hunter.Spells.WyvernSting.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Hunter.Spells.WyvernSting.Raid == true then
							if RSA.db.profile.Hunter.Spells.WyvernSting.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 35079 then -- MISDIRECTION THREAT TRANSFER BUFF
					...
					if RSA.db.profile.Hunter.Spells.Misdirection.Messages.Start ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.Misdirection.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.Misdirection.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.Misdirection.Party == true then
							if RSA.db.profile.Hunter.Spells.Misdirection.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Hunter.Spells.Misdirection.Raid == true then
							if RSA.db.profile.Hunter.Spells.Misdirection.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 90355 and dest == pName then -- ANCIENT HYSTERIA
					...
					if RSA.db.profile.Hunter.Spells.AncientHysteria.Messages.Start ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.AncientHysteria.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Hunter.Spells.AncientHysteria.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.AncientHysteria.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.AncientHysteria.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.AncientHysteria.Party == true then
							if RSA.db.profile.Hunter.Spells.AncientHysteria.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Hunter.Spells.AncientHysteria.Raid == true then
							if RSA.db.profile.Hunter.Spells.AncientHysteria.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_CREATE" then
				if spellID == 1499 or spellID == 60202 then -- FREEZING TRAP
					...
					if RSA.db.profile.Hunter.Spells.FreezingTrap.Messages.Placement ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.FreezingTrap.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.FreezingTrap.Messages.Placement, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.FreezingTrap.Party == true then
							if RSA.db.profile.Hunter.Spells.FreezingTrap.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_CAST_SUCCESS" then
				if spellID == 82654 then -- WIDOW VENOM
					...
					if RSA.db.profile.Hunter.Spells.WidowVenom.Messages.Start ~= "" then
						if RSA.db.profile.Hunter.Spells.WidowVenom.Local == true then
							RSA.Print_LibSink(string.gsub(RSA.db.profile.Hunter.Spells.WidowVenom.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.WidowVenom.Yell == true then
							RSA.Print_Yell(string.gsub(RSA.db.profile.Hunter.Spells.WidowVenom.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.WidowVenom.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Hunter.Spells.WidowVenom.Messages.Start, ".%a+.", RSA.String_Replace), RSA.db.profile.Hunter.Spells.WidowVenom.CustomChannel.Channel)
						end
						if RSA.db.profile.Hunter.Spells.WidowVenom.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Hunter.Spells.WidowVenom.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.WidowVenom.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.WidowVenom.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.WidowVenom.Party == true then
							if RSA.db.profile.Hunter.Spells.WidowVenom.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							RSA.Print_Party(string.gsub(RSA.db.profile.Hunter.Spells.WidowVenom.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.WidowVenom.Raid == true then
							if RSA.db.profile.Hunter.Spells.WidowVenom.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Hunter.Spells.WidowVenom.Messages.Start, ".%a+.", RSA.String_Replace))
						end
					end
				end -- WIDOW VENOM
				if spellID == 19503 then -- SCATTER SHOT
					...
					if RSA.db.profile.Hunter.Spells.ScatterShot.Messages.Start ~= "" then
						if RSA.db.profile.Hunter.Spells.ScatterShot.Local == true then
							RSA.Print_LibSink(string.gsub(RSA.db.profile.Hunter.Spells.ScatterShot.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.ScatterShot.Yell == true then
							RSA.Print_Yell(string.gsub(RSA.db.profile.Hunter.Spells.ScatterShot.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.ScatterShot.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Hunter.Spells.ScatterShot.Messages.Start, ".%a+.", RSA.String_Replace), RSA.db.profile.Hunter.Spells.ScatterShot.CustomChannel.Channel)
						end
						if RSA.db.profile.Hunter.Spells.ScatterShot.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Hunter.Spells.ScatterShot.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.ScatterShot.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.ScatterShot.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.ScatterShot.Party == true then
							if RSA.db.profile.Hunter.Spells.ScatterShot.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							RSA.Print_Party(string.gsub(RSA.db.profile.Hunter.Spells.ScatterShot.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.ScatterShot.Raid == true then
							if RSA.db.profile.Hunter.Spells.ScatterShot.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Hunter.Spells.ScatterShot.Messages.Start, ".%a+.", RSA.String_Replace))
						end
					end
				end -- SCATTER SHOT
				if spellID == 5116 then -- CONCUSSIVE SHOT
					...
					if RSA.db.profile.Hunter.Spells.ConcussiveShot.Messages.Start ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.ConcussiveShot.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.ConcussiveShot.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.ConcussiveShot.Party == true then
							if RSA.db.profile.Hunter.Spells.ConcussiveShot.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Hunter.Spells.ConcussiveShot.Raid == true then
							if RSA.db.profile.Hunter.Spells.ConcussiveShot.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 19263 then -- DETERRENCE
					...
					if RSA.db.profile.Hunter.Spells.Deterrence.Messages.Start ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.Deterrence.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.Deterrence.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.Deterrence.Party == true then
							if RSA.db.profile.Hunter.Spells.Deterrence.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Hunter.Spells.Deterrence.Raid == true then
							if RSA.db.profile.Hunter.Spells.Deterrence.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 51753 then -- CAMOFLAGE
					...
					if RSA.db.profile.Hunter.Spells.Camoflage.Messages.Start ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.Camoflage.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.Camoflage.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.Camoflage.Party == true then
							if RSA.db.profile.Hunter.Spells.Camoflage.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Hunter.Spells.Camoflage.Raid == true then
							if RSA.db.profile.Hunter.Spells.Camoflage.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 34477 and dest ~= pName then -- MISDIRECTION PRIMER
					...
					if RSA.db.profile.Hunter.Spells.Misdirection.Messages.Primer ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.Misdirection.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.Misdirection.Messages.Primer, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.Misdirection.Party == true then
							if RSA.db.profile.Hunter.Spells.Misdirection.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 53271 then -- MASTER'S CALL
					...
					if RSA.db.profile.Hunter.Spells.MastersCall.Messages.Start ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.MastersCall.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.MastersCall.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.MastersCall.Party == true then
							if RSA.db.profile.Hunter.Spells.MastersCall.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Hunter.Spells.MastersCall.Raid == true then
							if RSA.db.profile.Hunter.Spells.MastersCall.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 53480 then -- ROAR OF SACRIFICE
					...
					if RSA.db.profile.Hunter.Spells.RoarOfSacrifice.Messages.Start ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.RoarOfSacrifice.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.RoarOfSacrifice.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.RoarOfSacrifice.Party == true then
							if RSA.db.profile.Hunter.Spells.RoarOfSacrifice.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Hunter.Spells.RoarOfSacrifice.Raid == true then
							if RSA.db.profile.Hunter.Spells.RoarOfSacrifice.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 126393 then -- ETERNAL GUARDIAN
					...
					if RSA.db.profile.Hunter.Spells.EternalGuardian.Messages.Start ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.EternalGuardian.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Hunter.Spells.EternalGuardian.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.EternalGuardian.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.EternalGuardian.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.EternalGuardian.Party == true then
							if RSA.db.profile.Hunter.Spells.EternalGuardian.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Hunter.Spells.EternalGuardian.Raid == true then
							if RSA.db.profile.Hunter.Spells.EternalGuardian.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_INTERRUPT" then
				if  (spellID == 34490 or spellID == 147362) then -- SILENCING SHOT / COUNTER SHOT
					spellinfo = GetSpellInfo(spellID)
					spelllinkinfo = GetSpellLink(spellID)
					...
					if RSA.db.profile.Hunter.Spells.SilencingShot.Messages.Start ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.SilencingShot.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.SilencingShot.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.SilencingShot.Party == true then
							if RSA.db.profile.Hunter.Spells.SilencingShot.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Hunter.Spells.SilencingShot.Raid == true then
							if RSA.db.profile.Hunter.Spells.SilencingShot.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 19801 then -- TRANQUILIZING SHOT
					...
					if RSA.db.profile.Hunter.Spells.TranquilizingShot.Messages.Start ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.TranquilizingShot.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.TranquilizingShot.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.TranquilizingShot.Party == true then
							if RSA.db.profile.Hunter.Spells.TranquilizingShot.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Hunter.Spells.TranquilizingShot.Raid == true then
							if RSA.db.profile.Hunter.Spells.TranquilizingShot.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_DISPEL_FAILED" then
				if spellID == 19801 then -- TRANQUILIZING SHOT
					...
					if RSA.db.profile.Hunter.Spells.TranquilizingShot.Messages.End ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.TranquilizingShot.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.TranquilizingShot.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.TranquilizingShot.Party == true then
							if RSA.db.profile.Hunter.Spells.TranquilizingShot.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_AURA_REMOVED" then
				if spellID == 82654 then -- WIDOW VENOM
					...
					if RSA.db.profile.Hunter.Spells.WidowVenom.Messages.End ~= "" then
						if RSA.db.profile.Hunter.Spells.WidowVenom.Local == true then
							RSA.Print_LibSink(string.gsub(RSA.db.profile.Hunter.Spells.WidowVenom.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.WidowVenom.Yell == true then
							RSA.Print_Yell(string.gsub(RSA.db.profile.Hunter.Spells.WidowVenom.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.WidowVenom.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Hunter.Spells.WidowVenom.Messages.End, ".%a+.", RSA.String_Replace), RSA.db.profile.Hunter.Spells.WidowVenom.CustomChannel.Channel)
						end
						if RSA.db.profile.Hunter.Spells.WidowVenom.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Hunter.Spells.WidowVenom.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.WidowVenom.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.WidowVenom.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.WidowVenom.Party == true then
							if RSA.db.profile.Hunter.Spells.WidowVenom.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							RSA.Print_Party(string.gsub(RSA.db.profile.Hunter.Spells.WidowVenom.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.WidowVenom.Raid == true then
							if RSA.db.profile.Hunter.Spells.WidowVenom.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Hunter.Spells.WidowVenom.Messages.End, ".%a+.", RSA.String_Replace))
						end
					end
				end -- WIDOW VENOM
				if spellID == 19503 then -- SCATTER SHOT
					...
					if RSA.db.profile.Hunter.Spells.ScatterShot.Messages.End ~= "" then
						if RSA.db.profile.Hunter.Spells.ScatterShot.Local == true then
							RSA.Print_LibSink(string.gsub(RSA.db.profile.Hunter.Spells.ScatterShot.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.ScatterShot.Yell == true then
							RSA.Print_Yell(string.gsub(RSA.db.profile.Hunter.Spells.ScatterShot.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.ScatterShot.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Hunter.Spells.ScatterShot.Messages.End, ".%a+.", RSA.String_Replace), RSA.db.profile.Hunter.Spells.ScatterShot.CustomChannel.Channel)
						end
						if RSA.db.profile.Hunter.Spells.ScatterShot.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Hunter.Spells.ScatterShot.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.ScatterShot.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.ScatterShot.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.ScatterShot.Party == true then
							if RSA.db.profile.Hunter.Spells.ScatterShot.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							RSA.Print_Party(string.gsub(RSA.db.profile.Hunter.Spells.ScatterShot.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.ScatterShot.Raid == true then
							if RSA.db.profile.Hunter.Spells.ScatterShot.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Hunter.Spells.ScatterShot.Messages.End, ".%a+.", RSA.String_Replace))
						end
					end
				end -- SCATTER SHOT
				if spellID == 5116 then -- CONCUSSIVE SHOT
					...
					if RSA.db.profile.Hunter.Spells.ConcussiveShot.Messages.End ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.ConcussiveShot.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.ConcussiveShot.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.ConcussiveShot.Party == true then
							if RSA.db.profile.Hunter.Spells.ConcussiveShot.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 3355 then -- FREEZING TRAP
					...
					if RSA.db.profile.Hunter.Spells.FreezingTrap.Messages.End ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.FreezingTrap.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.FreezingTrap.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.FreezingTrap.Party == true then
							if RSA.db.profile.Hunter.Spells.FreezingTrap.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 19263 then -- DETERRENCE
					...
					if RSA.db.profile.Hunter.Spells.Deterrence.Messages.End ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.Deterrence.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.Deterrence.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.Deterrence.Party == true then
							if RSA.db.profile.Hunter.Spells.Deterrence.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 51755 then -- CAMOFLAGE
					...
					if RSA.db.profile.Hunter.Spells.Camoflage.Messages.End ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.Camoflage.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.Camoflage.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.Camoflage.Party == true then
							if RSA.db.profile.Hunter.Spells.Camoflage.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 19386 then -- WYVERN STING
					...
					if RSA.db.profile.Hunter.Spells.WyvernSting.Messages.End ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.WyvernSting.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.WyvernSting.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.WyvernSting.Party == true then
							if RSA.db.profile.Hunter.Spells.WyvernSting.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 35079 then -- MISDIRECTION THREAT TRANSFER BUFF
					...
					if RSA.db.profile.Hunter.Spells.Misdirection.Messages.End ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.Misdirection.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.Misdirection.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.Misdirection.Party == true then
							if RSA.db.profile.Hunter.Spells.Misdirection.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 53480 then -- ROAR OF SACRIFICE
					...
					if RSA.db.profile.Hunter.Spells.RoarOfSacrifice.Messages.End ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.RoarOfSacrifice.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.RoarOfSacrifice.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.RoarOfSacrifice.Party == true then
							if RSA.db.profile.Hunter.Spells.RoarOfSacrifice.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 90355 and dest == pName then -- ANCIENT HYSTERIA
					...
					if RSA.db.profile.Hunter.Spells.AncientHysteria.Messages.End ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.AncientHysteria.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.AncientHysteria.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.AncientHysteria.Party == true then
							if RSA.db.profile.Hunter.Spells.AncientHysteria.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_MISSED" and missType ~= "IMMUNE" then
				if spellID == 20736 then -- DISTRACTING SHOT
					...
					if RSA.db.profile.Hunter.Spells.DistractingShot.Messages.End ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.DistractingShot.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.DistractingShot.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.DistractingShot.Party == true then
							if RSA.db.profile.Hunter.Spells.DistractingShot.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if  (spellID == 34490 or spellID == 147362)  then -- SILENCING SHOT / COUNTER SHOT
					...
					if RSA.db.profile.Hunter.Spells.SilencingShot.Messages.End ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.SilencingShot.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.SilencingShot.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.SilencingShot.Party == true then
							if RSA.db.profile.Hunter.Spells.SilencingShot.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_MISSED" and missType == "IMMUNE" then
				if spellID == 20736 then -- DISTRACTING SHOT
					...
					if RSA.db.profile.Hunter.Spells.DistractingShot.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.DistractingShot.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.DistractingShot.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.DistractingShot.Party == true then
							if RSA.db.profile.Hunter.Spells.DistractingShot.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if (spellID == 34490 or spellID == 147362) then -- SILENCING SHOT / COUNTER SHOT
					...
					if RSA.db.profile.Hunter.Spells.SilencingShot.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Hunter.Spells.SilencingShot.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Hunter.Spells.SilencingShot.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Hunter.Spells.SilencingShot.Party == true then
							if RSA.db.profile.Hunter.Spells.SilencingShot.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
