...
function RSA_Druid:OnEnable()
	...
	local Config_Symbiosis = { -- SYMBIOSIS
		profile = 'Symbiosis',
	...
	local MonitorConfig_Druid = {
		...
		SPELL_AURA_APPLIED = {
			[110478] = Config_Symbiosis,
			[110479] = Config_Symbiosis,
			[110482] = Config_Symbiosis,
			[110483] = Config_Symbiosis,
			[110484] = Config_Symbiosis,
			[110485] = Config_Symbiosis,
			[110486] = Config_Symbiosis,
			[110488] = Config_Symbiosis,
			[110490] = Config_Symbiosis,
			[110491] = Config_Symbiosis,
				...
				if spellID == 80965 or spellID == 80964 or spellID == 93985 then -- SKULL BASH
					...
					if RSA.db.profile.Druid.Spells.SkullBash.Messages.Start ~= "" then
						...
						if RSA.db.profile.Druid.Spells.SkullBash.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Druid.Spells.SkullBash.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Druid.Spells.SkullBash.Party == true then
							if RSA.db.profile.Druid.Spells.SkullBash.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Druid.Spells.SkullBash.Raid == true then
							if RSA.db.profile.Druid.Spells.SkullBash.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 97547 then -- SOLAR BEAM
					...
					if RSA.db.profile.Druid.Spells.SolarBeam.Messages.Start ~= "" then
						...
						if RSA.db.profile.Druid.Spells.SolarBeam.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Druid.Spells.SolarBeam.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Druid.Spells.SolarBeam.Party == true then
							if RSA.db.profile.Druid.Spells.SolarBeam.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Druid.Spells.SolarBeam.Raid == true then
							if RSA.db.profile.Druid.Spells.SolarBeam.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 2908 then -- SOOTHE
					...
					if RSA.db.profile.Druid.Spells.Soothe.Messages.End ~= "" then
						...
						if RSA.db.profile.Druid.Spells.Soothe.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Druid.Spells.Soothe.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Druid.Spells.Soothe.Party == true then
							if RSA.db.profile.Druid.Spells.Soothe.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Druid.Spells.Soothe.Raid == true then
							if RSA.db.profile.Druid.Spells.Soothe.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_MISSED" and missType ~= "IMMUNE" then
				if spellID == 6795 then -- GROWL
					...
					if RSA.db.profile.Druid.Spells.Growl.Messages.End ~= "" then
						...
						if RSA.db.profile.Druid.Spells.Growl.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Druid.Spells.Growl.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Druid.Spells.Growl.Party == true then
							if RSA.db.profile.Druid.Spells.Growl.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Druid.Spells.Growl.Raid == true then
							if RSA.db.profile.Druid.Spells.Growl.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 80965 or spellID == 80964 or spellID == 93985 then -- SKULL BASH
					...
					if RSA.db.profile.Druid.Spells.SkullBash.Messages.End ~= "" then
						...
						if RSA.db.profile.Druid.Spells.SkullBash.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Druid.Spells.SkullBash.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Druid.Spells.SkullBash.Party == true then
							if RSA.db.profile.Druid.Spells.SkullBash.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_MISSED" and missType == "IMMUNE" then
				if spellID == 6795 then -- GROWL
					...
					if RSA.db.profile.Druid.Spells.Growl.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Druid.Spells.Growl.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Druid.Spells.Growl.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Druid.Spells.Growl.Party == true then
							if RSA.db.profile.Druid.Spells.Growl.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 80965 or spellID == 80964 or spellID == 93985 then -- SKULL BASH
					...
					if RSA.db.profile.Druid.Spells.SkullBash.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Druid.Spells.SkullBash.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Druid.Spells.SkullBash.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Druid.Spells.SkullBash.Party == true then
							if RSA.db.profile.Druid.Spells.SkullBash.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if spell == GetSpellInfo(50769) and RSA.db.profile.Druid.Spells.Revive.Messages.Start ~= "" then -- REVIVE
				if event == "UNIT_SPELLCAST_SENT" then
					...
					if RSA.db.profile.Druid.Spells.Revive.Messages.Start ~= "" then
						...
						if RSA.db.profile.Druid.Spells.Revive.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Druid.Spells.Revive.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Druid.Spells.Revive.Party == true then
							if RSA.db.profile.Druid.Spells.Revive.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Druid.Spells.Revive.Raid == true then
							if RSA.db.profile.Druid.Spells.Revive.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				elseif event == "UNIT_SPELLCAST_SUCCEEDED" and Ressed ~= true then
					...
					if RSA.db.profile.Druid.Spells.Revive.Messages.End ~= "" then
						...
						if RSA.db.profile.Druid.Spells.Revive.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Druid.Spells.Revive.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Druid.Spells.Revive.Party == true then
							if RSA.db.profile.Druid.Spells.Revive.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if spell == GetSpellInfo(20484) and RSA.db.profile.Druid.Spells.Rebirth.Messages.Start ~= "" then -- REBIRTH
				if event == "UNIT_SPELLCAST_SENT" then
					...
					if RSA.db.profile.Druid.Spells.Rebirth.Messages.Start ~= "" then
						...
						if RSA.db.profile.Druid.Spells.Rebirth.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Druid.Spells.Rebirth.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Druid.Spells.Rebirth.Party == true then
							if RSA.db.profile.Druid.Spells.Rebirth.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Druid.Spells.Rebirth.Raid == true then
							if RSA.db.profile.Druid.Spells.Rebirth.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				elseif event == "UNIT_SPELLCAST_SUCCEEDED" and Ressed ~= true then
					...
					if RSA.db.profile.Druid.Spells.Rebirth.Messages.End ~= "" then
						...
						if RSA.db.profile.Druid.Spells.Rebirth.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Druid.Spells.Rebirth.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Druid.Spells.Rebirth.Party == true then
							if RSA.db.profile.Druid.Spells.Rebirth.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
