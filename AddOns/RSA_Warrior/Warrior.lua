...
function RSA_Warrior:OnEnable()
	...
	-- Banners
	local guidDemoralizingBanner = 0
	local guidSkullBanner = 0
	local function Warrior_Spells(self, _, timestamp, event, hideCaster, sourceGUID, source, sourceFlags, sourceRaidFlag, destGUID, dest, destFlags, destRaidFlags, spellID, spellName, spellSchool, missType, ex2, ex3, ex4)
			...
			if missType == "REFLECT" then -- SPELL REFLECT
				...
				if RSA.db.profile.Warrior.Spells.SpellReflect.Messages.Start ~= "" then
					...
					if RSA.db.profile.Warrior.Spells.SpellReflect.Smart.RaidParty == true then
						RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.SpellReflect.Messages.Start, ".%a+.", RSA.String_Replace))
					end
					if RSA.db.profile.Warrior.Spells.SpellReflect.Party == true then
						if RSA.db.profile.Warrior.Spells.SpellReflect.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
					...
					if RSA.db.profile.Warrior.Spells.SpellReflect.Raid == true then
						if RSA.db.profile.Warrior.Spells.SpellReflect.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
		...
		if source == pName or source == petName then
			...
			if event == "SPELL_AURA_APPLIED" then
				if spellID == 355 then -- TAUNT
					...
					if RSA.db.profile.Warrior.Spells.Taunt.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.Taunt.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.Taunt.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Taunt.Party == true then
							if RSA.db.profile.Warrior.Spells.Taunt.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.Taunt.Raid == true then
							if RSA.db.profile.Warrior.Spells.Taunt.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 676 then -- DISARM
					...
					if RSA.db.profile.Warrior.Spells.Disarm.Messages.Start ~= "" then
						if RSA.db.profile.Warrior.Spells.Disarm.Local == true then
							RSA.Print_LibSink(string.gsub(RSA.db.profile.Warrior.Spells.Disarm.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Disarm.Yell == true then
							RSA.Print_Yell(string.gsub(RSA.db.profile.Warrior.Spells.Disarm.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Disarm.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Warrior.Spells.Disarm.Messages.Start, ".%a+.", RSA.String_Replace), RSA.db.profile.Warrior.Spells.Disarm.CustomChannel.Channel)
						end
						if RSA.db.profile.Warrior.Spells.Disarm.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Warrior.Spells.Disarm.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Disarm.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.Disarm.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Disarm.Party == true then
							if RSA.db.profile.Warrior.Spells.Disarm.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							RSA.Print_Party(string.gsub(RSA.db.profile.Warrior.Spells.Disarm.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Disarm.Raid == true then
							if RSA.db.profile.Warrior.Spells.Disarm.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Warrior.Spells.Disarm.Messages.Start, ".%a+.", RSA.String_Replace))
						end
					end
				end -- DISARM
				if spellID == 64382 then -- SHATTERING THROW
					...
					if RSA.db.profile.Warrior.Spells.ShatteringThrow.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.ShatteringThrow.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.ShatteringThrow.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.ShatteringThrow.Party == true then
							if RSA.db.profile.Warrior.Spells.ShatteringThrow.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.ShatteringThrow.Raid == true then
							if RSA.db.profile.Warrior.Spells.ShatteringThrow.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 1719 then -- RECKLESSNESS
					...
					if RSA.db.profile.Warrior.Spells.Recklessness.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.Recklessness.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.Recklessness.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Recklessness.Party == true then
							if RSA.db.profile.Warrior.Spells.Recklessness.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.Recklessness.Raid == true then
							if RSA.db.profile.Warrior.Spells.Recklessness.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 114030 then -- VIGILANCE
					...
					if RSA.db.profile.Warrior.Spells.Vigilance.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.Vigilance.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.Vigilance.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Vigilance.Party == true then
							if RSA.db.profile.Warrior.Spells.Vigilance.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.Vigilance.Raid == true then
							if RSA.db.profile.Warrior.Spells.Vigilance.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 18498 then -- PUMMEL (GAG ORDER)
					...
					if RSA.db.profile.Warrior.Spells.Pummel.Messages.Gag ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.Pummel.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.Pummel.Messages.Gag, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Pummel.Party == true then
							if RSA.db.profile.Warrior.Spells.Pummel.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.Pummel.Raid == true then
							if RSA.db.profile.Warrior.Spells.Pummel.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 132404 then -- SHIELD BLOCK
					...
					if RSA.db.profile.Warrior.Spells.ShieldBlock.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.ShieldBlock.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.ShieldBlock.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.ShieldBlock.Party == true then
							if RSA.db.profile.Warrior.Spells.ShieldBlock.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.ShieldBlock.Raid == true then
							if RSA.db.profile.Warrior.Spells.ShieldBlock.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 112048 then -- SHIELD BARRIER
					...
					if RSA.db.profile.Warrior.Spells.ShieldBarrier.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.ShieldBarrier.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Warrior.Spells.ShieldBarrier.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.ShieldBarrier.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.ShieldBarrier.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.ShieldBarrier.Party == true then
							if RSA.db.profile.Warrior.Spells.ShieldBarrier.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.ShieldBarrier.Raid == true then
							if RSA.db.profile.Warrior.Spells.ShieldBarrier.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 114192 then -- MOCKING BANNER
					...
					if RSA.db.profile.Warrior.Spells.MockingBanner.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.MockingBanner.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Warrior.Spells.MockingBanner.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.MockingBanner.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.MockingBanner.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.MockingBanner.Party == true then
							if RSA.db.profile.Warrior.Spells.MockingBanner.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.MockingBanner.Raid == true then
							if RSA.db.profile.Warrior.Spells.MockingBanner.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 118038 then -- DIE BY THE SWORD
					...
					if RSA.db.profile.Warrior.Spells.DieByTheSword.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.DieByTheSword.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Warrior.Spells.DieByTheSword.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DieByTheSword.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.DieByTheSword.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DieByTheSword.Party == true then
							if RSA.db.profile.Warrior.Spells.DieByTheSword.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.DieByTheSword.Raid == true then
							if RSA.db.profile.Warrior.Spells.DieByTheSword.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_CAST_SUCCESS" then
				if spellID == 871 then -- SHIELD WALL
					...
					if RSA.db.profile.Warrior.Spells.ShieldWall.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.ShieldWall.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.ShieldWall.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.ShieldWall.Party == true then
							if RSA.db.profile.Warrior.Spells.ShieldWall.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.ShieldWall.Raid == true then
							if RSA.db.profile.Warrior.Spells.ShieldWall.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 12975 then -- LAST STAND
					...
					if RSA.db.profile.Warrior.Spells.LastStand.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.LastStand.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.LastStand.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.LastStand.Party == true then
							if RSA.db.profile.Warrior.Spells.LastStand.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.LastStand.Raid == true then
							if RSA.db.profile.Warrior.Spells.LastStand.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 55694 then -- ENRAGED REGENERATION
					...
					if RSA.db.profile.Warrior.Spells.EnragedRegeneration.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.EnragedRegeneration.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.EnragedRegeneration.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.EnragedRegeneration.Party == true then
							if RSA.db.profile.Warrior.Spells.EnragedRegeneration.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.EnragedRegeneration.Raid == true then
							if RSA.db.profile.Warrior.Spells.EnragedRegeneration.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 97462 then -- RALLYING CRY
					...
					if RSA.db.profile.Warrior.Spells.RallyingCry.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.RallyingCry.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.RallyingCry.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.RallyingCry.Party == true then
							if RSA.db.profile.Warrior.Spells.RallyingCry.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.RallyingCry.Raid == true then
							if RSA.db.profile.Warrior.Spells.RallyingCry.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 3411 or spellID == 114029 then -- INTERVENE / SAFEGUARD
					...
					if RSA.db.profile.Warrior.Spells.Intervene.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.Intervene.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.Intervene.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Intervene.Party == true then
							if RSA.db.profile.Warrior.Spells.Intervene.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.Intervene.Raid == true then
							if RSA.db.profile.Warrior.Spells.Intervene.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 1160 then -- DEMORALIZING SHOUT
					...
					if RSA.db.profile.Warrior.Spells.DemoralizingShout.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.DemoralizingShout.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingShout.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DemoralizingShout.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingShout.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DemoralizingShout.Party == true then
							if RSA.db.profile.Warrior.Spells.DemoralizingShout.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.DemoralizingShout.Raid == true then
							if RSA.db.profile.Warrior.Spells.DemoralizingShout.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
					...
					if RSA.db.profile.Warrior.Spells.DemoralizingShout.Messages.End ~= "" then -- Demoralizing Shout ending doesn't appear on combat log
						...
						local function DSTimer(self, elapsed)
							...
							if RSA.db.profile.Warrior.Spells.DemoralizingShout.Smart.RaidParty == true then
								RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingShout.Messages.End, ".%a+.", RSA.String_Replace))
							end
							if RSA.db.profile.Warrior.Spells.DemoralizingShout.Party == true then
								if RSA.db.profile.Warrior.Spells.DemoralizingShout.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_INTERRUPT" then
				if spellID == 6552 then -- PUMMEL
					...
					if RSA.db.profile.Warrior.Spells.Pummel.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.Pummel.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.Pummel.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Pummel.Party == true then
							if RSA.db.profile.Warrior.Spells.Pummel.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_AURA_REMOVED" then
				if spellID == 64382 then -- SHATTERING THROW
					...
					if RSA.db.profile.Warrior.Spells.ShatteringThrow.Messages.End ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.ShatteringThrow.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.ShatteringThrow.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.ShatteringThrow.Party == true then
							if RSA.db.profile.Warrior.Spells.ShatteringThrow.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 114030 then -- VIGILANCE
					...
					if RSA.db.profile.Warrior.Spells.Vigilance.Messages.End ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.Vigilance.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.Vigilance.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Vigilance.Party == true then
							if RSA.db.profile.Warrior.Spells.Vigilance.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 871 then -- SHIELD WALL
					...
					if RSA.db.profile.Warrior.Spells.ShieldWall.Messages.End ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.ShieldWall.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.ShieldWall.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.ShieldWall.Party == true then
							if RSA.db.profile.Warrior.Spells.ShieldWall.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 12976 then -- LAST STAND
					...
					if RSA.db.profile.Warrior.Spells.LastStand.Messages.End ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.LastStand.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.LastStand.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.LastStand.Party == true then
							if RSA.db.profile.Warrior.Spells.LastStand.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 676 then -- DISARM
					...
					if RSA.db.profile.Warrior.Spells.Disarm.Messages.End ~= "" then
						if RSA.db.profile.Warrior.Spells.Disarm.Local == true then
							RSA.Print_LibSink(string.gsub(RSA.db.profile.Warrior.Spells.Disarm.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Disarm.Yell == true then
							RSA.Print_Yell(string.gsub(RSA.db.profile.Warrior.Spells.Disarm.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Disarm.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Warrior.Spells.Disarm.Messages.End, ".%a+.", RSA.String_Replace), RSA.db.profile.Warrior.Spells.Disarm.CustomChannel.Channel)
						end
						if RSA.db.profile.Warrior.Spells.Disarm.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Warrior.Spells.Disarm.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Disarm.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.Disarm.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Disarm.Party == true then
							if RSA.db.profile.Warrior.Spells.Disarm.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							RSA.Print_Party(string.gsub(RSA.db.profile.Warrior.Spells.Disarm.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Disarm.Raid == true then
							if RSA.db.profile.Warrior.Spells.Disarm.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Warrior.Spells.Disarm.Messages.End, ".%a+.", RSA.String_Replace))
						end
					end
				end -- DISARM
				if spellID == 55694 then -- ENRAGED REGENERATION
					...
					if RSA.db.profile.Warrior.Spells.EnragedRegeneration.Messages.End ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.EnragedRegeneration.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.EnragedRegeneration.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.EnragedRegeneration.Party == true then
							if RSA.db.profile.Warrior.Spells.EnragedRegeneration.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 2565 then -- SHIELD BLOCK
					...
					if RSA.db.profile.Warrior.Spells.ShieldBlock.Messages.End ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.ShieldBlock.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.ShieldBlock.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.ShieldBlock.Party == true then
							if RSA.db.profile.Warrior.Spells.ShieldBlock.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 112048 then -- SHIELD BARRIER
					...
					if RSA.db.profile.Warrior.Spells.ShieldBarrier.Messages.End ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.ShieldBarrier.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.ShieldBarrier.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.ShieldBarrier.Party == true then
							if RSA.db.profile.Warrior.Spells.ShieldBarrier.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 1719 then -- RECKLESSNESS
					...
					if RSA.db.profile.Warrior.Spells.Recklessness.Messages.End ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.Recklessness.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.Recklessness.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Recklessness.Party == true then
							if RSA.db.profile.Warrior.Spells.Recklessness.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 97463 and RSA_RallyingCry == false then -- RALLYING CRY
					...
					if RSA.db.profile.Warrior.Spells.RallyingCry.Messages.End ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.RallyingCry.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.RallyingCry.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.RallyingCry.Party == true then
							if RSA.db.profile.Warrior.Spells.RallyingCry.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 114192 then -- MOCKING BANNER
					...
					if RSA.db.profile.Warrior.Spells.MockingBanner.Messages.End ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.MockingBanner.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.MockingBanner.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.MockingBanner.Party == true then
							if RSA.db.profile.Warrior.Spells.MockingBanner.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 118038 then -- DIE BY THE SWORD
					...
					if RSA.db.profile.Warrior.Spells.DieByTheSword.Messages.End ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.DieByTheSword.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.DieByTheSword.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DieByTheSword.Party == true then
							if RSA.db.profile.Warrior.Spells.DieByTheSword.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 23922 then -- SHIELD SLAM DISPEL
					...
					if RSA.db.profile.Warrior.Spells.ShieldSlamDispel.Messages.Start ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.ShieldSlamDispel.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.ShieldSlamDispel.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.ShieldSlamDispel.Party == true then
							if RSA.db.profile.Warrior.Spells.ShieldSlamDispel.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Warrior.Spells.ShieldSlamDispel.Raid == true then
							if RSA.db.profile.Warrior.Spells.ShieldSlamDispel.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_DISPEL_FAILED" then
				if spellID == 23922 then -- SHIELD SLAM DISPEL
					...
					if RSA.db.profile.Warrior.Spells.ShieldSlamDispel.Messages.End ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.ShieldSlamDispel.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.ShieldSlamDispel.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.ShieldSlamDispel.Party == true then
							if RSA.db.profile.Warrior.Spells.ShieldSlamDispel.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_MISSED" and missType ~= "IMMUNE" then
				if spellID == 355 then -- TAUNT
					...
					if RSA.db.profile.Warrior.Spells.Taunt.Messages.End ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.Taunt.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.Taunt.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Taunt.Party == true then
							if RSA.db.profile.Warrior.Spells.Taunt.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 6552 then -- PUMMEL
					...
					if RSA.db.profile.Warrior.Spells.Pummel.Messages.End ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.Pummel.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.Pummel.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Pummel.Party == true then
							if RSA.db.profile.Warrior.Spells.Pummel.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_MISSED" and missType == "IMMUNE" then
				if spellID == 355 then -- TAUNT
					...
					if RSA.db.profile.Warrior.Spells.Taunt.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.Taunt.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.Taunt.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Taunt.Party == true then
							if RSA.db.profile.Warrior.Spells.Taunt.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
				...
				if spellID == 6552 then -- PUMMEL
					...
					if RSA.db.profile.Warrior.Spells.Pummel.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Warrior.Spells.Pummel.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.Pummel.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.Pummel.Party == true then
							if RSA.db.profile.Warrior.Spells.Pummel.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_SUMMON" then
				if spellID == 114207 then -- SKULL BANNER
					spellinfo = GetSpellInfo(spellID)
					spelllinkinfo = GetSpellLink(spellID)
					guidSkullBanner = destGUID
					RSA.Replacements = {["[SPELL]"] = spellinfo, ["[LINK]"] = spelllinkinfo,}
					if RSA.db.profile.Warrior.Spells.SkullBanner.Messages.Start ~= "" then
						if RSA.db.profile.Warrior.Spells.SkullBanner.Local == true then
							RSA.Print_LibSink(string.gsub(RSA.db.profile.Warrior.Spells.SkullBanner.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.SkullBanner.Yell == true then
							RSA.Print_Yell(string.gsub(RSA.db.profile.Warrior.Spells.SkullBanner.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.SkullBanner.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Warrior.Spells.SkullBanner.Messages.Start, ".%a+.", RSA.String_Replace), RSA.db.profile.Warrior.Spells.SkullBanner.CustomChannel.Channel)
						end
						if RSA.db.profile.Warrior.Spells.SkullBanner.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Warrior.Spells.SkullBanner.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.SkullBanner.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.SkullBanner.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.SkullBanner.Party == true then
							if RSA.db.profile.Warrior.Spells.SkullBanner.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							RSA.Print_Party(string.gsub(RSA.db.profile.Warrior.Spells.SkullBanner.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.SkullBanner.Raid == true then
							if RSA.db.profile.Warrior.Spells.SkullBanner.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Warrior.Spells.SkullBanner.Messages.Start, ".%a+.", RSA.String_Replace))
						end
					end
				end -- SKULL BANNER
				if spellID == 114203 then -- DEMORALIZING BANNER
					spellinfo = GetSpellInfo(spellID)
					spelllinkinfo = GetSpellLink(spellID)
					guidDemoralizingBanner = destGUID
					RSA.Replacements = {["[SPELL]"] = spellinfo, ["[LINK]"] = spelllinkinfo,}
					if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.Start ~= "" then
						if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Local == true then
							RSA.Print_LibSink(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Yell == true then
							RSA.Print_Yell(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DemoralizingBanner.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.Start, ".%a+.", RSA.String_Replace), RSA.db.profile.Warrior.Spells.DemoralizingBanner.CustomChannel.Channel)
						end
						if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Party == true then
							if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							RSA.Print_Party(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Raid == true then
							if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.Start, ".%a+.", RSA.String_Replace))
						end
					end
				end -- DEMORALIZING BANNER
			end -- IF EVENT IS SPELL_SUMMON
			if event == "UNIT_DESTROYED" then -- IF EVENT IS UNIT_DESTROYED
				if destGUID == guidDemoralizingBanner then -- DEMORALIZING BANNER
					spellinfo = GetSpellInfo(spellID)
					spelllinkinfo = GetSpellLink(spellID)
					RSA.Replacements = {["[SPELL]"] = spellinfo, ["[LINK]"] = spelllinkinfo,}
					if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.End ~= "" then
						if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Local == true then
							RSA.Print_LibSink(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Yell == true then
							RSA.Print_Yell(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DemoralizingBanner.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.End, ".%a+.", RSA.String_Replace), RSA.db.profile.Warrior.Spells.DemoralizingBanner.CustomChannel.Channel)
						end
						if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Party == true then
							if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							RSA.Print_Party(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Raid == true then
							if RSA.db.profile.Warrior.Spells.DemoralizingBanner.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Warrior.Spells.DemoralizingBanner.Messages.End, ".%a+.", RSA.String_Replace))
						end
					end
				end -- DEMORALIZING BANNER
				if destGUID == guidSkullBanner then -- SKULL BANNER
					spellinfo = GetSpellInfo(spellID)
					spelllinkinfo = GetSpellLink(spellID)
					RSA.Replacements = {["[SPELL]"] = spellinfo, ["[LINK]"] = spelllinkinfo,}
					if RSA.db.profile.Warrior.Spells.SkullBanner.Messages.End ~= "" then
						if RSA.db.profile.Warrior.Spells.SkullBanner.Local == true then
							RSA.Print_LibSink(string.gsub(RSA.db.profile.Warrior.Spells.SkullBanner.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.SkullBanner.Yell == true then
							RSA.Print_Yell(string.gsub(RSA.db.profile.Warrior.Spells.SkullBanner.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.SkullBanner.CustomChannel.Enabled == true then
							RSA.Print_Channel(string.gsub(RSA.db.profile.Warrior.Spells.SkullBanner.Messages.End, ".%a+.", RSA.String_Replace), RSA.db.profile.Warrior.Spells.SkullBanner.CustomChannel.Channel)
						end
						if RSA.db.profile.Warrior.Spells.SkullBanner.Smart.Say == true then
							RSA.Print_Say(string.gsub(RSA.db.profile.Warrior.Spells.SkullBanner.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.SkullBanner.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Warrior.Spells.SkullBanner.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.SkullBanner.Party == true then
							if RSA.db.profile.Warrior.Spells.SkullBanner.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
							RSA.Print_Party(string.gsub(RSA.db.profile.Warrior.Spells.SkullBanner.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Warrior.Spells.SkullBanner.Raid == true then
							if RSA.db.profile.Warrior.Spells.SkullBanner.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
							RSA.Print_Raid(string.gsub(RSA.db.profile.Warrior.Spells.SkullBanner.Messages.End, ".%a+.", RSA.String_Replace))
						end
					end
				end -- SKULL BANNER
