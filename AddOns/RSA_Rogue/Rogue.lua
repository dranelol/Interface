				...
				if spellID == 57934 then -- TRICKS OF THE TRADE DAMAGE BUFF
					...
					if RSA.db.profile.Rogue.Spells.Tricks.Messages.Start ~= "" then
						...
						if RSA.db.profile.Rogue.Spells.Tricks.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Rogue.Spells.Tricks.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Rogue.Spells.Tricks.Party == true then
							if RSA.db.profile.Rogue.Spells.Tricks.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Rogue.Spells.Tricks.Raid == true then
							if RSA.db.profile.Rogue.Spells.Tricks.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
				...
				if spellID == 1766 then -- KICK
					...
					if RSA.db.profile.Rogue.Spells.Kick.Messages.Start ~= "" then
						...
						if RSA.db.profile.Rogue.Spells.Kick.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Rogue.Spells.Kick.Messages.Start, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Rogue.Spells.Kick.Party == true then
							if RSA.db.profile.Rogue.Spells.Kick.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
						...
						if RSA.db.profile.Rogue.Spells.Kick.Raid == true then
							if RSA.db.profile.Rogue.Spells.Kick.Smart.RaidParty == true and GetNumGroupMembers() > 0 then return end
			...
			if event == "SPELL_AURA_REMOVED" then
				if spellID == 57933 then -- TRICKS OF THE TRADE DAMAGE BUFF
					...
					if RSA.db.profile.Rogue.Spells.Tricks.Messages.End ~= "" then
						...
						if RSA.db.profile.Rogue.Spells.Tricks.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Rogue.Spells.Tricks.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Rogue.Spells.Tricks.Party == true then
							if RSA.db.profile.Rogue.Spells.Tricks.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_MISSED" and missType ~= "IMMUNE" then
				if spellID == 1766 then -- KICK
					...
					if RSA.db.profile.Rogue.Spells.Kick.Messages.End ~= "" then
						...
						if RSA.db.profile.Rogue.Spells.Kick.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Rogue.Spells.Kick.Messages.End, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Rogue.Spells.Kick.Party == true then
							if RSA.db.profile.Rogue.Spells.Kick.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
			...
			if event == "SPELL_MISSED" and missType == "IMMUNE" then
				if spellID == 1766 then -- KICK
					...
					if RSA.db.profile.Rogue.Spells.Kick.Messages.Immune ~= "" then
						...
						if RSA.db.profile.Rogue.Spells.Kick.Smart.RaidParty == true then
							RSA.Print_Smart_RaidParty(string.gsub(RSA.db.profile.Rogue.Spells.Kick.Messages.Immune, ".%a+.", RSA.String_Replace))
						end
						if RSA.db.profile.Rogue.Spells.Kick.Party == true then
							if RSA.db.profile.Rogue.Spells.Kick.Smart.RaidParty == true and GetNumGroupMembers() == 0 and InstanceType ~= "arena" then return end
