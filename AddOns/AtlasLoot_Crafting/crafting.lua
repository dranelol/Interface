		...
		["Normal"] = {
			{
				...
				{ 2, "s47050", "35751", "=q4=Assassin's Alchemist Stone", "=ds="..BabbleFaction["Shattered Sun Offensive"].." - "..BabbleFaction["Exalted"]};
				{ 3, "s47046", "35748", "=q4=Guardian's Alchemist Stone", "=ds="..BabbleFaction["Shattered Sun Offensive"].." - "..BabbleFaction["Exalted"]};
				{ 4, "s47049", "35750", "=q4=Redeemer's Alchemist Stone", "=ds="..BabbleFaction["Shattered Sun Offensive"].." - "..BabbleFaction["Exalted"]};
				{ 5, "s47048", "35749", "=q4=Sorcerer's Alchemist Stone", "=ds="..BabbleFaction["Shattered Sun Offensive"].." - "..BabbleFaction["Exalted"]};
				{ 6, "s17632", "13503", "=q4=Alchemist's Stone", "=ds="..BabbleFaction["The Sha'tar"].." - "..BabbleFaction["Revered"]};
		...
		["Normal"] = {
			{
				...
				{ 2, "s88018", "62677", "=q1=Fish Fry", "=ds=#p3# (500)", "=ds="..AL["Cooking Daily"]};
				{ 3, "s88006", "62676", "=q1=Blackened Surprise", "=ds=#p3# (425)", "=ds="..AL["Trainer"]};
				{ 4, "s57421", "34747", "=q1=Northern Stew", "=ds=#p3# (350)", "=ds="..BabbleInventory["Quest"]};
				{ 5, "s42296", "33048", "=q1=Stewed Trout", "=ds=#p3# (320)", "=ds="..AL["Trainer"]};
				{ 6, "s33290", "27661", "=q1=Blackened Trout", "=ds=#p3# (300)", "=ds="..AL["Vendor"]..": "..BabbleZone["Zangarmarsh"]};
				{ 7, "s18247", "13935", "=q1=Baked Salmon", "=ds=#p3# (275)", "=ds="..AL["Vendor"]..": "..BabbleZone["Feralas"]};
				{ 8, "s18245", "13933", "=q1=Lobster Stew", "=ds=#p3# (275)", "=ds="..AL["Vendor"]..": "..BabbleZone["Feralas"]};
				{ 9, "s18241", "13930", "=q1=Filet of Redgill", "=ds=#p3# (225)", "=ds="..AL["Vendor"]..": "..BabbleZone["Stranglethorn Vale"]};
				{ 10, "s18238", "6887", "=q1=Spotted Yellowtail", "=ds=#p3# (225)", "=ds="..AL["Trainer"]};
				{ 11, "s20626", "16766", "=q1=Undermine Clam Chowder", "=ds=#p3# (225)", "=ds="..AL["Vendor"]..": "..BabbleZone["Tanaris"]};
				{ 12, "s20916", "8364", "=q1=Mithril Head Trout", "=ds=#p3# (175)", "=ds="..AL["Vendor"]};
				{ 13, "s7828", "4594", "=q1=Rockscale Cod", "=ds=#p3# (175)", "=ds="..AL["Vendor"]};
				{ 14, "s2548", "2685", "=q1=Succulent Pork Ribs", "=ds=#p3# (110)", "=ds="..AL["Drop"]};
				{ 15, "s7755", "4593", "=q1=Bristle Whisker Catfish", "=ds=#p3# (100)", "=ds="..AL["Vendor"]..""};
				{ 17, "s6501", "5526", "=q1=Clam Chowder", "=ds=#p3# (90)", "=ds="..AL["Vendor"]};
				{ 18, "s6417", "5478", "=q1=Dig Rat Stew", "=ds=#p3# (90)", "=ds="..AL["Vendor"]};
				{ 19, "s2543", "733", "=q1=Westfall Stew", "=ds=#p3# (90)", "=ds="..AL["Drop"]};
				{ 20, "s7754", "6316", "=q1=Loch Frenzy Delight", "=ds=#p3# (50)", "=ds="..AL["Vendor"]};	
				{ 21, "s7753", "4592", "=q1=Longjaw Mud Snapper", "=ds=#p3# (50)", "=ds="..AL["Vendor"]};
				{ 22, "s7827", "5095", "=q1=Rainbow Fin Albacore", "=ds=#p3# (50)", "=ds="..AL["Vendor"]};
				{ 23, "s93741", "67230", "=q1=Venison Jerky", "=ds=#p3# (40)", "=ds="..AL["Trainer"]};
				{ 24, "s8607", "6890", "=q1=Smoked Bear Meat", "=ds=#p3# (40)", "=ds="..AL["Vendor"]};
				{ 25, "s7751", "6290", "=q1=Brilliant Smallfish", "=ds=#p3# (1)", "=ds="..AL["Vendor"]};
				{ 26, "s2538", "2679", "=q1=Charred Wolf Meat", "=ds=#p3# (1)"};
				{ 27, "s2540", "2681", "=q1=Roasted Boar Meat", "=ds=#p3# (1)"};
				{ 28, "s7752", "787", "=q1=Slitherskin Mackerel", "=ds=#p3# (1)", "=ds="..AL["Vendor"]};
				{ 29, "s37836", "30816", "=q1=Spice Bread", "=ds=#p3# (1)", "=ds="..AL["Trainer"]};
			};
			{
				{ 1, 0, "INV_Box_01", "=q6="..AL["Mana"], ""};
				{ 2, "s88044", "62672", "=q1=South Island Ice Tea", "=ds=#p3# (525)", "=ds="..AL["Cooking Daily"]};
				{ 3, "s88045", "62675", "=q1=Starfire Espresso", "=ds=#p3# (450)", "=ds="..AL["Cooking Daily"]};
				{ 4, "s53056", "39520", "=q1=Kungaloosh", "=ds=#p3# (350)", "=ds=#QUESTID:13571#"};
				{ 5, "s13028", "10841", "=q1=Goldthorn Tea", "=ds=#p3# (175)", "=ds="..BabbleZone["Razorfen Downs"]};
				{ 7, 0, "INV_Box_01", "=q6="..AL["Health and Mana"], ""};
				{ 8, "s96133", "68687", "=q1=Scalding Murglesnout", "=ds=#p3# (500)", "=ds="..AL["Cooking Daily"]};
				{ 9, "s64358", "45932", "=q1=Black Jelly", "=ds=#p3# (400)", "=ds="..AL["Trainer"]};
				{ 10, "s45561", "34760", "=q1=Grilled Bonescale", "=ds=#p3# (350)", "=ds="..AL["Trainer"]};
				{ 11, "s42305", "33053", "=q1=Hot Buttered Trout", "=ds=#p3# (350)", "=ds="..AL["Trainer"]};
				{ 12, "s45562", "34761", "=q1=Sauteed Goby", "=ds=#p3# (350)", "=ds="..AL["Trainer"]};
				{ 13, "s45560", "34759", "=q1=Smoked Rockfin", "=ds=#p3# (350)", "=ds="..AL["Trainer"]};
				{ 14, "s2545", "2682", "=q1=Cooked Crab Claw", "=ds=#p3# (85)", "=ds="..AL["World Drop"]};
			};
		};
		info = {
			name = COOKING,
